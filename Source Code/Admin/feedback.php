...
<body style="background-color: rgb(235, 235, 235);">
   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
        ...
        <h1 class="h3 mb-0 text-gray-800">Feedback Pengunjung</h1>
    </div>
    ...
    <div class="col">
        <div class="card shadow mb-4">
            ...
            echo "<tr><th><center>Nama</center></th><th><center>Email</center></th><th><center>Saran</center></th><th><center>Opsi</center></th></tr>";
            foreach($hasil as $data){
                echo "<tr>";
                echo "<td><center>$data[firstname] $data[lastname]</center>";
                echo "<td><center>$data[email]</center>";
                echo "<td><center>$data[saran]</center>";                          
