...
<body style="background-color: rgb(235, 235, 235);">
   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
        ...
        <h1 class="h3 mb-0 text-gray-800">Komentar Anggota</h1>
    </div>
    ...
    <div class="col">
        <div class="card shadow mb-4">
            <div
                ...
                <h6 class="m-0 font-weight-bold text-primary">Komentar Resep</h6>
            </div>
            ...
            echo "<tr><th><center>Nama</center></th><th><center>Email</center></th><th><center>Komentar</center></th><th><center>Tanggal</center></th><th><center>Opsi</center></th></tr>";
            foreach($hasil as $data){
                echo "<tr>";
                echo "<td><center>$data[nama]</center>";
                echo "<td><center>$data[email]</center>";
                echo "<td><center>$data[komentar]</center>"; 
                echo "<td><center>$data[tanggal]</center>";                          
                ...
                <button type='submit' name='btnHapus' class='btn btn-danger'><center>Delete</center></button></form></td>";
                echo "</tr>";
                }                
                echo "</table>";
                ?>
