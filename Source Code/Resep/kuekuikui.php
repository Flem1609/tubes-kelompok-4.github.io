   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">KUE KUI-KUI</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI SULAWESI BARAT</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sulawesi/kuekuikui.jpg" alt="Kue Kui-Kui" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1 kg tepung terigu protein sedang</h5></li>
              <li><h5>4 butir telur</h5></li>
              <li><h5>6 ons gula</h5></li>
              <li><h5>Soda kue 1 sendok makan (fermipan)</h5></li>
              <li><h5>Secukupnya Garam</h5></li>
              <li><h5>1/2 sendok teh Panili bubuk</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Campur semua bahan sampai benar-benar rata</h5></li>
            <li><h5>Diamkan adonan selama ± 40 menit atau sampai adonan mengembang</h5></li>
            <li><h5>Panggang dalam cetakkan menggunakan api kecil sampai benar-benar matang (bisa cetakan pukis kotak/ bulat selera)</h5></li>
            <li><h5>Tambahkan toping meses atau warna campuran (selera)</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
