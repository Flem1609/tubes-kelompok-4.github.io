   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">ASAM KEUENG</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/asamkeueng.jpg" alt="Asam Keueng" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1 kg ikan tongkol</h5></li>
              <li><h5>1 batang sereh</h5></li>
              <li><h5>1 ruas jahe</h5></li>
              <li><h5>1 sdt ketumbar</h5></li>
              <li><h5>10 bh cabai rawit merah</h5></li>
              <li><h5>10 ptg asam suntih</h5></li>
              <li><h5>4 siung bawang putih</h5></li>
              <li><h5>7 siung bawang merah</h5></li>
              <li><h5>7 buah cabai merah</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Haluskan bumbu termasuk dengan asam suntih.</h5></li>
            <li><h5>Tumis bumbu yang dihaluskan, lalu masukkan ikan tongkol beserta air secukupnya.</h5></li>
            <li><h5>Tambahkan garam, gula, lalu koreksi rasa. Aduk rata, angkat dan sajikan.</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
