...
<body style="background-color: rgb(235, 235, 235);">
   ...
   <div class="wrapper d-flex align-items-stretch">
    ...
    <div class="container"> <div class=" text-center mt-5 ">
        <h2>List Makanan Kalimantan dan Sulawesi</h2>
    </div>
    <div class="row mt-3">
    ...
    <table class="table table-bordered table-hover">
        ...
        $query2 = "SELECT * FROM makanan WHERE makanan LIKE '%".$cari."%' AND asal LIKE 'Kalimantan dan Sulawesi' ORDER BY id ASC LIMIT $offset,$limit";
    ...
    <div class="row">
      <nav aria-label="Page navigation example" class="mx-auto">
        <ul class="pagination">
          ...
          ?>
          <li class="page-item"><a class="page-link" href="<?php echo "listmakanan2.php?halaman=$sebelum"; ?>">Sebelumnya</a></li>
          <?php } ?>
          <?php
          if ($halaman==2){
            echo "";
          ...
          ?>         
          <li class="page-item"><a class="page-link" href="<?php echo "listmakanan2.php?halaman=$sesudah"; ?>">Selanjutnya</a></li>
          <?php } ?>
        </ul>
      </nav>
    </div>
