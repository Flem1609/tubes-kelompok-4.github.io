   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">TIMPHAN</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI NAGGROE ACEH DARUSSALAM</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/timphan.jpg" alt="Timphan" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>500 gr labu kuning</h5></li>
              <li><h5>500 gr tepung ketan</h5></li>
              <li><h5>1 sdt garam</h5></li>
              <li><h5>3 tangkai daun pisang muda</h5></li>
              <li><h5>Minyak goreng untuk olesan</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan-unti :</h2>
            <ul type="disc">
              <li><h5>2 buah kelapa, parut</h5></li>
              <li><h5>1 sdt garam</h5></li>
              <li><h5>2 lembar daun pandan, simpulkan</h5></li>
              <li><h5>5 sdm air</h5></li>
              <li><h5>600 gr gula pasir</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Kupas labu kuning dan potong-potong, kemudian rebus selama 15 menit.</h5></li>
            <li><h5>Untuk unti kelapa, panaskan wajan menggunakan api kecil, masukkan 1 sendok sayur gula, kemudian aduk-aduk hingga menjadi karamel.</h5></li>
            <li><h5>Masukkan air agar karamel tidak mengeras, tambahkan kelapa parut, garam, daun pandan dan sisa gula secara bertahap, aduk sampai tercampur rata sampai airnya kering dan kelapa berwarna merah.</h5></li>
            <li><h5>Haluskan labu yang sudah dingin.</h5></li>
            <li><h5>Tambahkan garam dan tepung sedikit demi sedikit kemudian uleni sampai kalis.</h5></li>
            <li><h5>Ambil selembar daun pisang oleskan minyak dan bulatkan kecil adonan kemudian pipihkan sampai tipis. Tambahkan unti kelapa. Lipat dengan rapi.</h5></li>
            <li><h5>Kukus selama 20 menit, angkat dan sajikan.</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
