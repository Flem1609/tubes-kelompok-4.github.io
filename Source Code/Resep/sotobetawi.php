   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">SOTO BETAWI</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI JAKARTA</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Jawa/sotobetawi.jpg" alt="Soto Betawi" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>Daging sapi sebanyak ½ kg</h5></li>
              <li><h5>Susu cair tawar sebanyak 200 ml</h5></li>
              <li><h5>Santan kelapa sebanyak 300 ml</h5></li>
              <li><h5>Tomat sebanyak 4 buah yang telah dipotong kotak-kotak menyerupai dadu</h5></li>
              <li><h5>Kentang yang telah direbus sebanyak 4 buah</h5></li>
              <li><h5>Daun jeruk sejumlah 2 lembar</h5></li>
              <li><h5>Daun salam sejumlah 2 lembar</h5></li>
              <li><h5>Kayu manis sepanjang 3 cm</h5></li>
              <li><h5>Lengkuas sepanjang 2 cm yang telah dimemarkan</h5></li>
              <li><h5>Kapulaga sebanyak 2 atau 3 buah</h5></li>
              <li><h5>Serai sejumlah 1 batang yang telah dimemarkan</h5></li>
              <li><h5>Garam, minyak goreng secukupnya</h5></li>
              <li><h5>Daun bawang secukupnya</h5></li>
              <li><h5>Emping goreng dan bawang merah goreng secukupnya</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu-halus :</h2>
            <ul type="disc">
              <li><h5>Bawang putih sejumlah 6 siung</h5></li>
              <li><h5>Bawang merah sejumlah 8 siung</h5></li>
              <li><h5>Ketumbar bubuk sebanyak 1 sendok teh</h5></li>
              <li><h5>Jintan sebanyak ½ sendok teh</h5></li>
              <li><h5>Merica bubuk sebanyak ½ sendok makan</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Cuci daging hingga bersih. Lalu masak daging hingga matang dengan cara direbus. Air rebusan daging jangan dibuang, karena akan digunakan sebagai kuah soto.</h5></li>
            <li><h5>Setelah matang, daging kemudian digoreng lalu tiriskan.</h5></li>
            <li><h5>Haluskan bawang putih, bawang merah, ketumbar bubuk, jintan, dan merica bubuk. Kemudian tumis dengan sedikit minyak hingga harum. Lalu masukkan tumisan bumbu halus tersebut ke dalam air rebusan daging sapi.</h5></li>
            <li><h5>Masukkan pula bahan-bahan lain seperti daun jeruk, daun salam, kayu manis, lengkuas, kapulaga, serai, dan garam.</h5></li>
            <li><h5>Tambahkan juga ke dalamnya susu cair serta santan kelapa. Masak kembali hingga soto matang sempurna</h5></li>
            <li><h5>Siapkan sebuah mangkuk, lalu masukkan ke dalamnya daging sapi dan kentang yang telah dipotong-potong sebelumnya. Siram dengan kuah soto</h5></li>
            <li><h5>Beri tambahan berupa potongan tomat, irisan daun bawang, emping goreng, serta bawang merah goreng</h5></li>
            <li><h5>Soto Betawi pun siap disantap dengan ditemani nasi putih hangat</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
