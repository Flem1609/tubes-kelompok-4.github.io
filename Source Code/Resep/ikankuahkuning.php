   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">IKAN KUAH KUNING</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI MALUKU</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Maluku/ikankuahkuning.jpg" alt="Ikan Kuah Kuning" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1/2 kg ikan kembung/ tongkol, dll (sy pake ikan Jahan)</h5></li>
              <li><h5>1 buah jeruk nipis</h5></li>
              <li><h5>2 batang sereh, geprek</h5></li>
              <li><h5>3 lembar daun jeruk</h5></li>
              <li><h5>2 lembar daun salam</h5></li>
              <li><h5>1 ruas lengkuas, geprek</h5></li>
              <li><h5>1 buah tomat merah, potong²</h5></li>
              <li><h5>Semangkuk daun kemangi</h5></li>
              <li><h5>6 buah belimbing wuluh, potong²</h5></li>
              <li><h5>10 buah cabe rawit merah utuh</h5></li>
              <li><h5>Secukupnya garam, kaldu bubuk, gula</h5></li>
              <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu-halus :</h2>
            <ul type="disc">
              <li><h5>5 butir bwg merah</h5></li>
              <li><h5>3 siung bwg putih</h5></li>
              <li><h5>5 buah cabe rawit merah</h5></li>
              <li><h5>5 cabe merah keriting (sy skip)</h5></li>
              <li><h5>2 butir kemiri</h5></li>
              <li><h5>1 sdt lada butir (sy pake lada bubuk)</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
              <li><h5>Cuci bersih ikan, buang kotorannya lalu potong2. Lumuri dengan jeruk nipis, diamkan 30 menit. Cuci bersih kembali.</h5></li>
              <li><h5>Goreng ikan 1/2 matang, tdk perlu sampai berkulit. (ditahap ini, kalo kata saya sih boleh kalo gak mau di goreng dulu, artinya langsung cemplung kuah)</h5></li>
              <li><h5>Tumis bumbu halus, daun salam, daun jeruk, sereh, lengkuas hingga harum.</h5></li>
              <li><h5>Beri air secukupnya, masukkan ikan, belimbing, dan cabai utuh. Masukkan kaldu jamur/garam dan gula secukupnya. Masak hingga ikan matang dan bumbu meresap. Jangan lupa koreksi rasa.</h5></li>
              <li><h5>Sesaat sebelum dimatikan kompornya, masukkan tomat dan daun kemangi. Aduk sebentar dan matikan kompor. Siap disajikan</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
