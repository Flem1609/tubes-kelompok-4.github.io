   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">Bebek Betutu</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI Bali</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Bali dan Sekitarnya/bebekbetutu.jpg" alt="Bebek Betutu" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
            <li><h5>1 ekor bebek, belah tengah dan lebarkan</h5></li>
              <li><h5>1 buah jeruk nipis</h5></li>
              <li><h5>1/2 sendok makan garam</h5></li>
              <li><h5>90 ml santan kental</h5></li>
              <li><h5>1 ruas kencur cincang halus</h5></li>
              <li><h5>1 ruas kunyit bakar, cincang halus</h5></li>
              <li><h5>1 sendok teh ketumbar bubuk</h5></li>
              <li><h5>1 sendok teh merica bubuk</h5></li>
              <li><h5>1 sendok teh pala bubuk</h5></li>
              <li><h5>1/4 sendok teh kunyit bubuk</h5></li>
              <li><h5>10 siung bawang merah, iris halus</h5></li>
              <li><h5>2 batang serai, ambil bagian putihnya, cincang halus</h5></li>
              <li><h5>2 ruas jahe, cincang halus</h5></li>
              <li><h5>2 ruas lengkuas, iris kasar, dan pipihkan</h5></li>
              <li><h5>2 sendok teh terasi bakar</h5></li>
              <li><h5>3 lembar daun jeruk, buang tulang tengahnya dan iris halus</h5></li>
              <li><h5>5 cabai merah besar, buang bijinya, iris halus</h5></li>
              <li><h5>5 cabai rawit orange, iris halus</h5></li> 
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Siapkan bebek, lumuri permukaannya dengan air jeruk nipis dan garam.</h5></li>
              <li><h5>Sisihkan bebek selama 15 menit, lalu cuci bersih.</h5></li>
              <li><h5>Siapkan wajan dan panaskan minyak.</h5></li>
              <li><h5>Masukkan semua bahan bumbu, tumis hingga harum dan matang.</h5></li>
              <li><h5>Tambahkan garam, gula, kaldu bubuk, dan bubuk-bubuk lainnya secukupnya.</h5></li>
              <li><h5>Masukkan bebek dan lumuri permukaannya dengan tumisan bumbu.</h5></li>
              <li><h5>Tutup wajan dan ungkep dengan api kecil hingga berubah warna dan bumbu meresap.</h5></li>
              <li><h5>Masukkan 1/2 campuran air dan santan.</h5></li>
              <li><h5>Aduk-aduk hingga santan dan bumbu tercampur merata.</h5></li>
              <li><h5>Tutup wajan rapat-rapat dan masak hingga air habis.</h5></li>
              <li><h5>Balikkan bebek, masukkan 1/2 sisa santan.</h5></li>
              <li><h5>Tutup wajan dan masak kembali hingga air habis dan bebek matang.</h5></li>
              <li><h5>Cek kematangan bebek. Caranya dengan tusuk dan robek menggunkan garpu. Jika belum matang, tambahkan air dan masak kembali.</h5></li>
              <li><h5>Untuk hasil maksimal, panggang sebentar di oven. Atau bisa juga dipanggang di bara api dan panggangan di kompor.</h5></li>
              <li><h5>Siapkan loyang datar, alasi loyang dengan selembar alumunium foil, lalu letakkan bebek diatasnya.</h5></li>
              <li><h5>Panggang di dalam oven bersuhu 180 derajat celcius selama 15-20 menit hingga bumbu terlihat mengering.</h5></li>
              <li><h5>Keluarkan bebek dari oven.</h5></li>
              <li><h5>Bebek betutu siap untuk disajikan</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
