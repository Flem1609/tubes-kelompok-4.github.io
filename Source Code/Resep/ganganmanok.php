   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">GANGAN MANOK</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Kalimantan/ganganmanok.jpg" alt="Gangan Manok" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1 ikat bayam, potong-potong</h5></li>
              <li><h5>1 buah oyong ukuran sedang, kupas, potong-potong</h5></li>
              <li><h5>½ sdt merica bubuk</h5></li>
              <li><h5>1 sdm garam</h5></li>
              <li><h5>1,5 liter air kaldu ayam</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan bola-bola ayam :</h2>
            <ul type="disc">
              <li><h5>200 gram ayam giling</h5></li>
              <li><h5>3 sdm tepung maizena</h5></li>
              <li><h5>2 butir putih telur, kocok lepas</h5></li>
              <li><h5>½ sdt merica bubuk</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
              <li><h5>Bola-bola ayam: Aduk rata semua bahan, bentuk menjadi bulatan-bulatan. Sisihkan.</h5></li>
              <li><h5>Panaskan air kaldu hingga mendidih, kecilkan apinya.</h5></li>
              <li><h5>Masukkan bola-bola ayam, masak hingga matang(mengapung). Besarkan kembali apinya.</h5></li>
              <li><h5>Masukkan sisa bahan (oyong, bayam, garam, dan merica bubuk). Masak sampai matang. Angkat.</h5></li>           
            </ul>         
          </div>
        </div>    
    </section>
