   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">GULAI TEMPOYAK DURIAN IKAN PATIN</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/gulaitempoyakikanpatin.jpg" alt="Gulai Tempoyak" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col ml-5">
            ...
            <ul type="disc">
              <li><h5>1 ekor ikan patin, potong-potong</h5></li>
              <li><h5>175 gr tempoyak</h5></li>
              <li><h5>5 lembardaunjeruk, buang tulangnya</h5></li>
              <li><h5>2 lembardaunsalam</li></h5>
              <li><h5>2 batang serai, memarkan</li></h5>
              <li><h5>½ sdm garam </li></h5>
              <li><h5>1 sdt gula</li></h5>
              <li><h5>800 ml air </li></h5>
              <li><h5>3 sdm minyak untuk menumis</li></h5>
            <h2 style="font-family: 'Lobster', cursive; margin-bottom: 20px; margin-left:-35px">Bumbu Halus :</h2>
              <li><h5>8 bawang merah</li></h5>
              <li><h5>5 siung bawang putih</li></h5>
              <li><h5>10 cabai merah keriting</li></h5>
              <li><h5>3 butir kemiri sangrai</li></h5>
              <li><h5>1 cm lengkuas</li></h5>
              <li><h5>2 cm kunyit bakar</li></h5>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Siapkan wajan untuk masak. Masukkan bumbu halus, daun jeruk, daun salam, jahe dan serai. Tumis sampai mengeluarkan aroma harum.</li> 
            <li><h5>Tuang air dan masukkan tempoyak. </li> 
            <li><h5>Masukan patin, masak hingga patin matang sempurna. Tidak usah terlalu sering diaduk agar patin tidak hancur. </li> 
            <li><h5>Untuk kuah yang kental, tambahkan 2 sdt maizena aduk bersama setengah gelas air lalu tuang ke kuali, aduk pelan dan tunggu hingga mendidih. Cek rasa, angkat lalu sajikan</li> 
            </ul>         
          </div>
        </div>    
    </section>
