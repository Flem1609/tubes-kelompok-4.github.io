...
<head>
    ...
    <title>Roti Jala Kari Spesial</title>
   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">ROTI JALA KARI SPESIAL</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI RIAU</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/rotijalakarispesial.jpg" alt="Roti Jala" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>500 gram tepung terigu</h5></li>
              <li><h5>1 butir telur</h5></li>
              <li><h5>300 ml air</h5></li>
              <li><h5>1 sdm garam</h5></li>
              <li><h5>2 sdm minyak sayur</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan-kari spesial :</h2>
            <ul type="disc">
              <li><h5>1/2 ekor ayam, potong ukuran kecil</h5></li>
              <li><h5>4 butir telur rebus, kupas kulitnya</h5></li>
              <li><h5>3 buah kentang, belah menjadi 4-6 potong</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu-kari spesial :</h2>
            <ul type="disc">
              <li><h5>2 sdm bubuk cabai merah</h5></li>
              <li><h5>5 siung bawang merah, haluskan</h5></li>
              <li><h5>5 siung bawang putih, haluskan</h5></li>
              <li><h5>4 butir kapulaga</h5></li>
              <li><h5>3 butir bunga lawang</h5></li>
              <li><h5>4 butir cengkeh</h5></li>
              <li><h5>1 potong kayu manis</h5></li>
              <li><h5>1/2 sdt kaskas</h5></li>
              <li><h5>1 sdm ketumbar halus</h5></li>
              <li><h5>1/3 sdt jintan halus</h5></li>
              <li><h5>1 sdm kunyit halus</h5></li>
              <li><h5>2 lembar daun salam</h5></li>
              <li><h5>3 lembar daun jeruk</h5></li>
              <li><h5>1 batang serai</h5></li>
              <li><h5>600 cc santan dari 1 butir kelapa</h5></li>
              <li><h5>Garam secukupnya</h5></li>
              <li><h5>2 sdm minyak untuk menumis</h5></li>
              <li><h5>50 cc air</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkah Membuat Roti :</h2>
            <ul type="circle">
            <li><h5>Campurkan tepung terigu, air, telur, minyak sayur, dan garam. Kocok dengan mixer sampai kalis dan saring</h5></li>
            <li><h5>Masukkan adonan ke dalam wadah cetakan roti jala atau gunakan botol air mineral yang tutupnya dilubangi dua sampai tiga lubang</h5></li>
            <li><h5>Panaskan teflon ukuran sedang yang sudah diolesi sedikit minyak untuk memulai menjala adonan hingga selesai. Gunakan api kecil</h5></li>
            <li><h5>Sajikan dengan kari spesial dan acar</h5></li>
            </ul> 
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkah Membuat Kari :</h2>
            <ul type="circle">
            <li><h5>Tumis bawang merah, bawang putih, bubuk cabai, kunyit, jintan, dan ketumbar sampai harum</h5></li>
            <li><h5>Masukkan potongan ayam, kapulaga, bunga lawang, cengkeh, kaskas, kayu manis, daun jeruk, daun salam, dan serai</h5></li>
            <li><h5>Tambahkan sedikit air biar tidak gosong. Aduk. Masukkan santan dan garam, cek rasa</h5></li>
            <li><h5>Tambahkan kentang, masak hingga lunak, lalu masukkan telur. Masak hingga kuah mengental sambil diaduk agar santan tidak pecah. Siap disajikan dengan roti jala dan acar</h5></li>
            </ul>        
          </div>
        </div>    
    </section>
