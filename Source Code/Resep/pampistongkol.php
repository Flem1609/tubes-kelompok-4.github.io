   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">PAMPIS TONGKOL</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sulawesi/pampistongkol.jpg" alt="Pampis Tongkol" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1 ekor ikan tongkol</h5></li>
              <li><h5>Air jeruk nipis</h5></li>
              <li><h5>2 batang serai, memarkan</h5></li>
              <li><h5>5 lembar daun jeruk</h5></li>
              <li><h5>2 lembar daun kunyit, iris halus</h5></li>
              <li><h5>1 lembar daun pandan, ikat simpul</h5></li>
              <li><h5>1 rantang daun kemangi petik</h5></li>
              <li><h5>2 batang daun bawang, iris</h5></li>
              <li><h5>Garam dan gula pasir secukupnya</h5></li>
              <li><h5>20 butir bawang merah</h5></li>
              <li><h5>8 siung bawang putih</h5></li>
              <li><h5>20 buah cabai merah keriting</h5></li>
              <li><h5>25 buah cabai rawit merah</h5></li>
              <li><h5>Seruas kunyit</h5></li>
              <li><h5>Seruas jahe</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Bersihkan ikan tongkol, beri garam dan air jeruk nipis. Diamkan sebentar, kukus sampai matang. Suwir-suwir dagingnya. Sisihkan</h5></li>
            <li><h5>Tumis bumbu halus bersama bumbu faun kecuali kemangi sampai harum. Beri garam dan gula secukupnya</h5></li>
            <li><h5>Masukkan ikan tongkol suwir, aduk rata sampai bumbu meresap</h5></li>
            <li><h5>Sebelum diangkat masukkan kemangi. Aduk sebentar.</h5></li>
            <li><h5>Sajikan.</h5></li>
            </ul>         
          </div>
        </div>    
