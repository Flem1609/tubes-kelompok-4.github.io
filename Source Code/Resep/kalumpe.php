   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">KALUMPE</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Kalimantan/kalumpe.jpg" alt="Kalumpe" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>Daun singkong, ditumbuk halus</h5></li>
              <li><h5>Terong kecil / teung pipit atau teung tangurit.</h5></li>
              <li><h5>Rawen rungkai / rawen sungkai yang akan menghasilkan rasa manis dan gurih, sebagai pengganti MSG</h5></li>
              <li><h5>Lantar / sulu, dikupas, dipotong dan dicuci bersih</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu :</h2>
            <ul type="disc">
              <li><h5>Bawang merah, haluskan</h5></li>
              <li><h5>Bawang putih, haluskan</h5></li>
              <li><h5>Lengkuas</h5></li>
              <li><h5>Serai, geprek</h5></li>
              <li><h5>Kayu manis Lombok</h5></li>                
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Tumbuk halus singkong, daun rawenrungkai / rawensungkai dan terongkecil / teung pipit.</h5></li>
            <li><h5>Sipakanpanci, campurkanbumbuhalus, lengkuas, serai, kayumanis dan Lombok bersama tumbukan daun singkong, masak dengan api kecil.</h5></li>
            <li><h5>Setelah mendidih masukkan potongan lantar/sulurkaladi. Setelah lantar atau sulurkeladi lunak, segera masukkan santan kental sambil di aduk-aduk.</h5></li>
            <li><h5>Angkat dan hidangkan bersama sambal terasi pedas dan goreng ikan asin (pundang) lais.</h5></li>            
            </ul>         
          </div>
        </div>    
    </section>
