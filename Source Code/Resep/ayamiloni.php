   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">AYAM ILONI GORONTALO</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI GORONTALO</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sulawesi/ayamiloni.jpg" alt="Ayam Iloni" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>600 gram ayam (10 buah sayap ayam)</h5></li>
              <li><h5>2 lembar daun pandan</h5></li>
              <li><h5>1 batang serai</h5></li>
              <li><h5>300 ml santan</h5></li>
              <li><h5>1/4 sdt jintan bubuk</h5></li>
              <li><h5>1/4 sdt cinnamon bubuk</h5></li>
              <li><h5>1/2 sdt gula pasir </h5></li>
              <li><h5>1 buah jeruk lemon, ambil airnya </h5></li>
              ...
              <li><h5>4 buah kemiri</h5></li>
              <li><h5>1 cm kunyit</h5></li>
              <li><h5>5 buah bawang merah</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
            <li><h5>Lumuri sayap ayam dengan air jeruk , diamkan 10 menit. Cuci bersih.</h5></li>
            <li><h5>Haluskan bumbu, tumis sampai harum, tambahkan serai, daun pandan, cinnamon bubuk, jintan bubuk dan lada bubuk.</h5></li>
            <li><h5>Masukkan ayam kedalam tumisan bumbu, beri santan, gula dan garam masak hingga matang dan santan habis.</h5></li>
            <li><h5>Oven/panggang ayam sampai kuning kecoklatan. Sajikan </h5></li>
            <li><h5>NB : Saat memanggang ayam olesi dengan sisa bumbu, dijamin tambah enak. Rasanya enak bangett ada rasa pedas dari cabe, gurih dari santan dan wangi dari daun pandan juga cinnamon.</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
