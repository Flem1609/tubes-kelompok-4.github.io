   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">KAREDOK</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI JAWA BARAT</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Jawa/karedok.jpg" alt="Karedok" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>Tauge, cuci bersih - 50 gram</h5></li>
              <li><h5>Kacang panjang, cuci bersih dan iris kecil - 50 gram</h5></li>
              <li><h5>Kol, cuci bersih dan iris halus - 50 gram</h5></li>
              <li><h5>Daun kemangi, cuci bersih - 50 gram</h5></li>
              <li><h5>Terong bulat hijau, cuci bersih dan iris tipis - 2 buah</h5></li>
              <li><h5>Ketimun, cuci bersih dan iris kotak tipis - 1 buah</h5></li>
              <li><h5>Kacang tanah, goreng - 150 gram</h5></li>
              <li><h5>Gula merah - 50 gram</h5></li>
              <li><h5>Bawang putih - 1 siung</h5></li>
              <li><h5>Cabe rawit merah - 2 buah</h5></li>
              <li><h5>Kencur - 4 cm</h5></li>
              <li><h5>Terasi, bakar - 1/2 sdt</h5></li>
              <li><h5>Air asam jawa - 2 sdm</h5></li>
              <li><h5>Garam - 1 sdt</h5></li>
              <li><h5>Air - 75 ml</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Dalam satu wadah besar, siapkan bumbu halus. Campur dengan air dan aduk hingga jadi pasta.</h5></li>
            <li><h5>Masukkan semua sayuran. Aduk hingga rata.</h5></li>
            <li><h5>Tambahkan perasan jeruk limau (opsional)</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
