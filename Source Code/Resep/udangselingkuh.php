   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">UDANG SELINKUH</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Papua/udangselingkuh.jpg" alt="Udang Selinkuh" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col ml-5 mt-2">
            ...
            <ul type="disc">
              <li><h5>8 ekor udang selingkuh </h5></li>
              <li><h5>1 sendok teh garam</h5></li>
              <li><h5>1 sendok makan air jeruk nipis</h5></li>
              <li><h5>1 siung bawang putih, parut</h5></li>
              <li><h5>1 sendok makan margarin, lelehkan</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan-bumbu :</h2>
            <ul type="disc">
              <li><h5>100 ml kecap manis</h5></li>
              <li><h5>2 sdm saus cabai (sesuaikan dengan selera)</h5></li>
              <li><h5>1 sdm bawang merah goreng, haluskan</h5></li>
              <li><h5>1 sdm air jeruk nipis</h5></li>
              <li><h5>1/2 sendok teh merica bubuk</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
              <li><h5>Cuci dan bersihkan bahan utama, yaitu udang selingkuh</h5></li>
              <li><h5>Lumuri seluruh bagian udang dengan garam, air jeruk nipis, dan bawang putih hingga merata</h5></li>
              <li><h5>Diamkan sejenak selama 30 menit</h5></li>
              <li><h5>Aduk margarin yang sudah dilelehkan dengan bumbu olesan yang telah dibuat sebelumnya hingga tercampur rata. Kemudian oleskan pada udang secara merata</h5></li>
              <li><h5>Setelah udang dioles bumbu hingga rata, bakar udang selingkuh di atas bara api hingga matang dan jangan lupa untuk tetap mengolesi bumbu</h5></li>
              <li><h5>Angkat udang dan sajikan</h5></li>
              <li><h5>Tambahkan lalapan sebagai pendamping.</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
