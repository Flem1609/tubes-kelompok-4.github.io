   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">KETUPAT KANDANGAN</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Kalimantan/ketupatkandangan.jpg" alt="Ketupat Kandangan" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1 ekor (600 g) ikan mujair</h5></li>
              <li><h5>1 sdm air jeruk nipis</h5></li>
              <li><h5>1 sdm air asam jawa</h5></li>
              <li><h5>½ sdt garam </h5></li>               
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu Halus :</h2>
            <ul type="disc">
              <li><h5>7 butir bawang merah</h5></li>
              <li><h5>3 siung bawang putih</h5></li>
              <li><h5>3 butir kemiri</h5></li>
              <li><h5>1 sdt ketumbar bubuk</h5></li>
              <li><h5>1 cm jahe</h5></li>
              <li><h5>1 sdt jintan bubuk</h5></li>    
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Kuah :</h2>
            <ul type="disc">
              <li><h5>1 batang serai, memarkan</h5></li>
              <li><h5>2 lembar daun jeruk, buang tulang daunnya, iris</h5></li>
              <li><h5>2 sdt Royco Kaldu Ayam</h5></li>
              <li><h5>1 sdt gula pasir</h5></li>
              <li><h5>½ sdt merica putih bubuk</h5></li>
              <li><h5>200 ml santan encer</h5></li>
              <li><h5>500 ml air</h5></li>
              <li><h5>3 sdm minyak, untuk menumis</h5></li>                       
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Pelengkap :</h2>
            <ul type="disc">
              <li><h5>2 buah ketupat, potong setebal 3 cm</h5></li>
              <li><h5>Bawang merah goreng, untuk taburan</h5></li>                                          
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Lumuri ikan mujair dengan jeruk nipis, air asam jawa, dan garam.</h5></li>
            <li><h5>Panaskan grill pan, panggang ikan hingga matang.</h5></li>
            <li><h5>Panaskan minyak, tumis bumbu halus, serai, dan daun jeruk hingga harum. Tambahkan air dan santan, aduk rata.</h5></li>
            <li><h5>Masukkan royco kaldu ayam, gula, merica, dan ikan. Aduk rata, masak hingga bumbu meresap. Angkat.</h5></li>
            <li><h5>Masukkan potongan ketupat kedalam mangkuk saji. Masukkan ikan dan kuahnya. Sajikan bersama taburan bawang goreng.</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
