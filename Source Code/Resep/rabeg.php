   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">RABEG</h1>
          <br>
          <h2 style="font-family: 'Lobster', cursive;">RESEP MAKANAN DAERAH KHAS YANG BERASAL DARI PROVINSI BANTEN</h2>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Jawa/rabeg.jpg" alt="Rabeg" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
            <li><h5>Daging sapi - 300 gram</h5></li>
            <li><h5>Air - 800 ml</h5></li>
            <li><h5>Sereh, geprek - 1 batang</h5></li>
            <li><h5>Daun jeruk - 2 lembar</h5></li>
            <li><h5>Kayu manis - 1 batang</h5></li>
            <li><h5>Kapulaga - 2 buah</h5></li>
            <li><h5>Jahe, geprek - 4 ruas</h5></li>
            <li><h5>Kecap manis - 5 sdm</h5></li>
            <li><h5>Merica bubuk - 1/4 sdt</h5></li>
            <li><h5>Garam,gula - 1 sdt</h5></li>
            <li><h5>Kaldu jamur - 1 sdt</h5></li>
            <li><h5>Minyak, untuk menumis - secukupnya</h5></li>
            <li><h5>Bawang merah - 5 siung</h5></li>  
            <li><h5>Bawang putih - 3 siung</h5></li> 
            <li><h5>Pala - 1/4 biji</h5></li> 
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Rebus daging dengan 800 ml air matang, sereh dan daun jeruk hingga empuk. Sisihkan dagingnya</h5></li>
            <li><h5>Tumis bumbu halus dengan sedikit minyak, kapulaga, kayu manis dan jahe.</h5></li>
            <li><h5>Masukkan daging, aduk rata</h5></li>
            <li><h5>Tambahkan 500 ml air matang, kecap manis dan sisa bumbu lainnya</h5></li>
            <li><h5>Masak hingga bumbu meresap dan air menyusut</h5></li>
            <li><h5>Tips : Bisa menggunakan daging bagian mana pun, termasuk jeroan. Atau daging kambing.Untuk menyingkat waktu memasak anda dapat menggunakan presto untuk mengempukkan daging.</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
