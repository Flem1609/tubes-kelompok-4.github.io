   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <p><h1 style="font-family: 'Lobster', cursive;">BUBUR SAGU AMBON</h1></p>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI MALUKU</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Maluku/bubursagu.jpg" alt="Bubur Sagu" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1 panci kecil</h5></li>
              <li><h5>3 keping sagu ambon</h5></li>
              <li><h5>2 gandu gula merah</h5></li>
              <li><h5>Secukupnya garam</h5></li>
              <li><h5>3 sdm gula pasir</h5></li>
              <li><h5>65 ml santan instan</h5></li>
              <li><h5>1 lbr daun pandan</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
              <li><h5>Rendam sagu dengan air panas secukupnya kira kira 4 jam atau sampai lembek</h5></li>
              <li><h5>Setelah sagu lembek, didihkan air secukupnya, jgn terlalu banyak agar bubur tidak encer karna kita pakai juga air rendaman sagunya, tambahkan gula pasir, gula merah, garam dan daun pandan, masak hingga gula merah larut</h5></li>
              <li><h5>Setelah mendidih dan gula larut masukkan rendaman sagu aduk aduk hingga matang, koreksi rasa manisnya sesuai selera</h5></li>
              <li><h5>Utk membuat santannya, sy pakai santan instan di beri air mendidih beri garam secukupnya aduk rata. Tuang di atas bubur dan siap di nikmati</h5></li>
              </ul>         
          </div>
        </div>    
    </section>
