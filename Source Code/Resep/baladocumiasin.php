   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">BALADO CUMI ASIN</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI SUMATERA BARAT'</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/baladocumiasin.jpg" alt="Balado Cumi Asin" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>300 gr cumi asin</h5></li>
              <li><h5>2 papan pete</h5></li>
              <li><h5>1 batang serai geprek</h5></li>
              <li><h5>3 lembar daun salam</h5></li>
              <li><h5>5 lembar daun jeruk</h5></li>
              <li><h5>Garam, gula halus, perasa sedikit</h5></li>
            </ul>
            ...
            <ul type="disc">
              ...
              <li><h5>15 cabai merah kering rendam dulu</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
            <li><h5>Rendam cumi asin tiriskan</h5></li>
            <li><h5>Panaskan minyak, tumis bahan halus sampai harum, masukkan serai, daun salam, dan daun jeruk tumis sampai wangi</h5></li>
            <li><h5>Masukkan cumi asin dan pete tumis dan tambahkan garam, gula dan perasa, test rasa</h5></li>
            <li><h5>Angkat dan sajikan dengan nasi hangat</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
