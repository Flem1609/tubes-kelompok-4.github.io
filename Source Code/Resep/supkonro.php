...
<head>
    ...
    <title>Sup Konro Makassar</title>
   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">SUP KONRO MAKASSAR</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI SULAWESI SELATAN</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sulawesi/supkonro.jpg" alt="Sup Konro" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1 kg Iga Sapi</h5></li>
              <li><h5>Air secukupnya, untuk merebus Iga</h5></li>
              <li><h5>7 siung bawang putih</h5></li>
              <li><h5>10 Sium bawang merah</h5></li>
              <li><h5>1 sdt Jinten, sangrai</h5></li>
              <li><h5>1 sdt ketumbar, sangrai</h5></li>
              <li><h5>1 sdt merica</h5></li>
              <li><h5>4 buah kluwek, rendam air panas</h5></li>
              <li><h5>3 butir kemiri, sangrai</h5></li>
              <li><h5>1 ruas jahe</h5></li>
              <li><h5>5 batang serai (ambil bagian putihnya)</h5></li>
              <li><h5>1 ruas lengkuas</h5></li>
              <li><h5>1 buah biji pala</h5></li>
              <li><h5>1 genggam kacang tanah, goreng & haluskan</h5></li>
              <li><h5>1 ruas kunyit</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Pelengkap :</h2>
            <ul type="disc">
              <li><h5>3 lembar daun salam</h5></li>
              <li><h5>1 ruas lengkuas, memarkan</h5></li>
              <li><h5>Secukupnya Kayu manis</h5></li>
              <li><h5>Secukupnya Air asam</h5></li>
              <li><h5>Bawang goreng</h5></li>
              <li><h5>Daun seledri</h5></li>
              <li><h5>Jeruk nipis</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Siapkan semua bahan yang di perlukan</h5></li>
            <li><h5>Cuci tulang iga hingga bersih, kemudian rebus iga hingga empuk.</h5></li>
            <li><h5>Sambil menunggu iga lunak/empuk, sangrai jinten, ketumbar dan kemiri. Angkat dan sisihkan.</h5></li>
            <li><h5>Lalu haluskan semua bumbu hingga halus.</h5></li>
            <li><h5>Setelah halus kemudian tumis bumbu halus tadi, tambahkan daun salam, lengkuas geprek/yg di memarkan, hingga matang dan harum.</h5></li>
            <li><h5>Kemudian masukan bumbu halus yang sudah di tumis tadi kedalam air rebusan iga.</h5></li>
            <li><h5>Lalu tambahkan air asam Jawa, kayu manis masak hingga bumbu meresap kemudian tambahkan garam dan kaldu bubuk. Tes rata, matikan kompor.</h5></li>
            <li><h5>Sup konro pun siap untuk di sajikan</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
