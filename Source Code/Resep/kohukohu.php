   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">KOHU-KOHU</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Maluku/kohukohu.jpg" alt="Kohu-Kohu" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>3 ekor ikan kembung</h5></li>
              <li><h5>5 utas kacang panjang, potong-potong</h5></li>
              <li><h5>1 genggam tauge, blansir air panas sebentar</h5></li>
              <li><h5>1 buah timun, potong dadu kecil</h5></li>
              <li><h5>1/2 genggam kemangi</h5></li>
              <li><h5>secukupnya Kelapa parut</h5></li>
              <li><h5>1/2 buah jeruk nipis</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu :</h2>
            <ul type="disc">
              <li><h5>3 butir bawang merah</h5></li>
              <li><h5>5 buah cabai rawit oranye</h5></li>
              <li><h5>3 buah cabai keriting merah</h5></li>
              <li><h5>1 sdt terasi</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
              <li><h5>Kukus kembung, lalu suwir-suwir. Sisihkan</h5></li>
              <li><h5>Haluskan semua bumbu, lalu campur dengan kelapa parut. Kukus selama 10 menit, angkat</h5></li>
              <li><h5>Campurkan kelapa berbumbu dengan sayuran dan suwiran ikan, beri perasan jeruk nipis, aduk rata, sajikan</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
