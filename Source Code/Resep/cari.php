    ...
    <div class="row">
      <nav aria-label="Page navigation example" class="mx-auto">
        <ul class="pagination">
          ...
          ?>
          <li class="page-item"><a class="page-link" href="<?php echo "cari.php?halaman=$sebelum"; ?>">Sebelumnya</a></li>
          <?php } ?>
          <?php
          for ($i=1; $i<=$jlh_halaman; $i++){
            echo "<li class=page-item><a class=page-link href=cari.php?halaman=$i>$i</a></li>";
          }
          ?>
          <?php
          if ($halaman==5){
          ...
          ?>         
          <li class="page-item"><a class="page-link" href="<?php echo "cari.php?halaman=$sesudah"; ?>">Selanjutnya</a></li>
          <?php } ?>
        </ul>
      </nav>
    </div>
