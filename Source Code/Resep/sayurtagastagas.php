   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">SAYUR TAGAS TAGAS</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Papua/sayurtagastagas.jpg" alt="Sayur Tagas" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>Secukup nya daun pepaya</h5></li>
              <li><h5>Secukup nya daun singkong</h5></li>
              <li><h5>Secukup nya daun kangkung</h5></li>
              <li><h5>Bunga pepaya secukup nya</h5></li>
              <li><h5>Sesuai selera Cabe rawit + cabe keriting</h5></li>
              <li><h5>4 siung Bawang putih</h5></li>
              <li><h5>3 siung bawang merah</h5></li>
              <li><h5>Terasi secukup nya</h5></li>
              <li><h5>sesuai selera Garam, gula dan penyedap</h5></li>
              <li><h5>Sereh dan daun jeruk secukup mya</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
              <li><h5>Cuci bersih sayur sayuran kemudian rajang halus</h5></li>
              <li><h5>Untuk daun pepaya kalau tidak suka pahit setelah di rajang boleh di rebus bentar saja bersama garam secukup nya..</h5></li>
              <li><h5>Setelah di rajang cuci bersi sayur tiriskan</h5></li>
              <li><h5>Blender halus bumbu</h5></li>
              <li><h5>Panaskan wajan tuang minyak secukup nya</h5></li>
              <li><h5>Tumis bumbu hingga harum tambahkan daun jeruk dan sereh secukup nya masak sayur hingga agak layu jangan di tambah air lagi y karna dari sayur sendiri suda mengandung air</h5></li>
              <li><h5>Terakir maukan garam, gula penyedap aduk rata</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
