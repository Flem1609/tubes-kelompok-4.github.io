   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">LALAMPA</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI SULAWESI TENGAH</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sulawesi/lalampa.jpg" alt="Lalampa" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1/2 kg beras ketan, rendam 2 jam</h5></li>
              <li><h5>400 ml santan dari ½ butir kelapa</h5></li>
              <li><h5>1 sdt garam</h5></li>
              <li><h5>3 sdm minyak untuk mengoles</h5></li>
              <li><h5>daun pisang untuk membungkus</h5></li>
              <li><h5>300 gram daging ikan tongkol, suwir-suwir</h5></li>
              <li><h5>2 lbr daun pandan, sobek dan simpul</h5></li>
              <li><h5>5 lbr daun jeruk purut, iris halus</h5></li>
              <li><h5>1 ruas jari jahe, memarkan</h5></li>
              <li><h5>1 btg serai, memarkan</h5></li>
              <li><h5>1 ikat kemangi, ambil daunnya</h5></li>
              <li><h5>1 buah tomat, potong-potong</h5></li>
              <li><h5>250 ml santan dari 1 butir kelapa</h5></li>
              <li><h5>3 sdm minyak untuk menumis</h5></li>
              <li><h5>8 butir bawang merah</h5></li>
              <li><h5>4 siung bawang putih</h5></li>
              <li><h5>6 buah cabai merah</h5></li>
              <li><h5>3 butir kemiri sangrai</h5></li>
              <li><h5>1/2 sdt kaldu instant</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Kukus ketan hingga setengah matang. Masukkan santan dan garam, aduk rata lalu kukus lagi hingga matang, angkat.</h5></li>
            <li><h5>Panaskan minyak, tumis bumbu halus sampai harum. Masukkan daun pandan, daun jeruk, jahe, dan serai, aduk hingga layu. Masukkan daging ikan tongkol, aduk rata. Masukkan daun kemangi, tomat dan santan, masak hingga kuah mengering lalu angkat, keluarkan daun pandan lalu dinginkan untuk digunakan sebagai isi</h5></li>
            <li><h5>Ambil 1 sdm ketan, letakkan di atas daun pisang dan tekan hingga rata. Beri isi di tengahnya lalu tutup lagi dengan ketan dan padatkan, gulung menjadi bulatan seperti lontong, semat dengan lidi.</h5></li>
            <li><h5>Olesi dengan minyak lalu bakar sebentar hingga daun kecoklatan.</h5></li>
            <li><h5>Angkat dan sajikan. Lalampa tobili siap dihidangkan</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
