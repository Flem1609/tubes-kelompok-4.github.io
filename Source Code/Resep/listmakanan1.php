...
<head>
    ...
    <title>List Makanan Indonesia Bagian Barat</title>
...
<body style="background-color: rgb(235, 235, 235);">
   ...
   <div class="wrapper d-flex align-items-stretch">
    ...
    <div class="container"> <div class=" text-center mt-5 ">
        <h2>List Makanan Sumatera dan Jawa</h2>
    </div>
    <div class="row mt-3">
    ...
    <table class="table table-bordered table-hover">
        ...
        if (isset($_POST['cari'])) {
          ...
          $sql="SELECT * FROM makanan WHERE makanan LIKE '%".$cari."%' AND asal LIKE 'Sumatera dan Jawa' ORDER BY id ASC";
        } else {
    ...
    <div class="row">
      <nav aria-label="Page navigation example" class="mx-auto">
        <ul class="pagination">
          ...
          ?>
          <li class="page-item"><a class="page-link" href="<?php echo "listmakanan1.php?halaman=$sebelum"; ?>">Sebelumnya</a></li>
          <?php } ?>
          <?php
          for ($i=1; $i<=$jlh_halaman; $i++){
            echo "<li class=page-item><a class=page-link href=listmakanan1.php?halaman=$i>$i</a></li>";
          }
          ?>
          <?php
          if ($halaman==3){
          ...
          ?>         
          <li class="page-item"><a class="page-link" href="<?php echo "listmakanan1.php?halaman=$sesudah"; ?>">Selanjutnya</a></li>
          <?php } ?>
        </ul>
      </nav>
    </div>
