   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">Ayam Bumbu Bali</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Bali dan Sekitarnya/ayambumbubali.jpg" alt="Ayam Bumbu Bali" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
            <li><h5>1 ekor ayam, potong-potong</h5></li>
              <li><h5>1 sendok teh gula pasir</h5></li>
              <li><h5>1/4 sendok teh merica bubuk</h5></li>
              <li><h5>2 sendok teh garam</h5></li>
              <li><h5>3 lembar daun salam</h5></li>
              <li><h5>3 sendok makan minyak untuk menumis</h5></li>
              <li><h5>700 ml air</h5></li>
              <li><h5>1 buah tomat</h5></li>
              <li><h5>1 sendok teh terasi, dibakar</h5></li>
              <li><h5>10 butir bawang merah</h5></li>
              <li><h5>4 siung bawang putih</h5></li>
              <li><h5>6 buah cabai merah besar</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
            <li><h5>Panaskan minyak.</h5></li>
            <li><h5>Masukkan bumbu halus dan daun salam,tumis hingga harum.</h5></li>
            <li><h5>Masukkan ayam lalu aduk hingga berubah warna.</h5></li>
            <li><h5>Tambahkan garam, gula, dan merica. Aduk rata.</h5></li>
            <li><h5>Tambahkan air.</h5></li>
            <li><h5>Masak hingga matang dan bumbunya meresap.</h5></li>
            <li><h5>Ayam bumbu Bali siap disajikan.</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
