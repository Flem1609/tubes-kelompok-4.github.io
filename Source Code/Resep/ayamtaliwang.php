   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">Ayam Taliwang</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI NTB</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Bali dan Sekitarnya/ayamtaliwang.jpg" alt="Ayam Taliwang" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
            <li><h5>1 ekor ayam</h5></li>
              <li><h5>1 sdm gula merah, sisir</h5></li>
              ...
              <li><h5>1 sdt rebon atau 1 cm terasi</h5></li>
              <li><h5>10 buah cabai keriting</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
            <li><h5>Tumis bumbu halus hingga harum. Masukkan ayam dan aduk rata dengan bumbu. Masak sambil diaduk-aduk hingga bumbu matang atau ayam berubah warna.</h5></li>
              <li><h5>Tuang air secukupnya. Masukkan gula dan garam secukupnya. Masak hingga ayam matang dan empuk. Tes rasa, masak lagi hingga air habis.</h5></li>
              <li><h5>Panggang ayam beserta bumbu hingga kering dan terpanggang sempurna. </h5></li>
            </ul>         
          </div>
        </div>    
    </section>
