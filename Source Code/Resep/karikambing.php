    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1 kg daging kambing</h5></li>
              <li><h5>1 buah labu air</h5></li>
              <li><h5>Santan</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu-halus :</h2>
              <ul>
                <li><h5>1/2 buah pala</h5></li>
                <li><h5>1 batang serai</h5></li>
                <li><h5>1 sdt lada hitam</h5></li>
                <li><h5>12 siung bawang merah</h5></li>
                <li><h5>2 jari jahe</h5></li>
                <li><h5>2 jari lengkuas</h5></li>
                <li><h5>3 sdm ketumbar</h5></li>
                <li><h5>6 buah cengkeh</h5></li>
                <li><h5>6 buah kapulaga</h5></li>
                <li><h5>8 siung bawang putih</h5></li>
                <li><h5>Cabai merah sesuai selera</h5></li>
              </ul>
            </h2>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan-tumis :</h2>
            <ul type="disc">
              <li><h5>1 batang serai</h5></li>
              <li><h5>2 jari lengkuas</h5></li>
              <li><h5>10 cm kayu manis</h5></li>
              <li><h5>2 biji bunga lawang</h5></li>
              <li><h5>1 genggam daun kari</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Haluskan semua bumbu. Geprek serai dan lengkuas.</h5></li>
            <li><h5>Panaskan minyak, masukan bumbu tumis hingga harum, lalu tambahkan bahan bumbu halus.</h5></li>
            <li><h5>Masukkan daging kambing, tutup sebentar dan tambahkan air. Biarkan sampai mendidih sambil diaduk.</h5></li>
