   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">LAWA</h1>
          <br>
          <h2 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI KALIMANTAN UTARA</h2>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Kalimantan/lawa.jpg" alt="Lawa" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>Timun</h5></li>
              <li><h5>Udang galah</h5></li>
              <li><h5>Daging buah Kelapa muda </h5></li>
              <li><h5>Lada Hitam</h5></li>
              <li><h5>Bawang Merah</h5></li>
              <li><h5>Garam</h5></li>
              <li><h5>Gula Pasir</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Timun dikupas, buang isinya, cuci bersih</h5></li>
            <li><h5>Timun diiris halus / diserut, sisihkan</h5></li>
            <li><h5>Kelapa muda diparut</h5></li>
            <li><h5>Lalu kelapa Muda disangrai hingga kering, sisihkan</h5></li>
            <li><h5>Udang Galah digoreng matang</h5></li>
            <li><h5>Campur semua yang sudah dipersiapkan, aduk semua hingga rata</h5></li>
            <li><h5>Lawa Sayur siap disajikan.</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
