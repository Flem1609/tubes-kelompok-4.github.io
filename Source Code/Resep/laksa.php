   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">LAKSA</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI KALIMANTAN SELATAN</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Kalimantan/laksa.jpg" alt="Laksa" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan Mie :</h2>
            <ul type="disc">
              <li><h5>500 gr tepung beras</h5></li>
              <li><h5>2 sdt air kapur dan air secukupnya</h5></li>           
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu Kuah :</h2>
            <ul type="disc">
              <li><h5>15 buah bawang merah</h5></li>
              <li><h5>7 buah bawang putih</h5></li>
              <li><h5>7 biji kemiri / keminting</h5></li>
              <li><h5>4 cm lengkuas</h5></li>
              <li><h5>4 cm kunyit</h5></li>
              <li><h5>4 cm jahe</h5></li>
              <li><h5>4 cm kencur</h5></li>
              <li><h5>2 batang serai ambil putihnya</h5></li>
              <li><h5>4 buah cabe merah besar</h5></li>
              <li><h5>1/2 sdt terasi</h5></li>
              <li><h5>Secukupnya gula dan garam</h5></li>             
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan Terpisah :</h2>
            <ul type="disc">
              <li><h5>1 ekor ikan gabus</h5></li>
              <li><h5>1 butir santan dari kelapa besar (pisahkan perasan pertama dengan perasan berikutnya)</h5></li>
              <li><h5>2 sdm minyak goreng </h5></li>              
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkah membuat mie :</h2>
            <ul type="circle">
            <li><h5>Larutkan tepung beras, air kapur dan2lt air biasa dalam wadah ukuran sedang, lalu aduk</h5></li>l
            <li><h5>Masak dengan api sedang, lalu aduk aduk hingga larutan tepung mengental</h5></li>
            <li><h5>Masukkan adonan ke dalam cetakan laksa, dengan bentuk bulat sesuai selera</h5></li>
            <li><h5>Cetak, lalu alasi dengan daun pisang. Panaskan panci untuk mengukus. Kukus selama 15 menit</h5></li>
              
            </ul>        
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkah membuat kuah :</h2>
            <ul type="circle">
            <li><h5>Rebus ikan gabung lalu pisahkan daging dengan tulangnya. Lalu cambuk ke bumbu yang sudah dihaluskan, ulek hingga ikan halus.</h5></li>
            <li><h5>Tumis bumbu halus yg sudah dicampur ikan hingga bumbu masak. Masukkan bumbu ke panci, lalu masukkan santan perasan yg ke 2,3 dan ke 4. masak hingga mendidih.</h5></li>
            <li><h5>Masukkan santan perasan pertama dan terus menerus diaduk hingga mendidih. Sajikan.</h5></li>             
            </ul>    
          </div>
        </div>    
    </section>
