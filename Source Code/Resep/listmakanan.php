   ...
   <div class="wrapper d-flex align-items-stretch">
    ...
    <table class="table table-bordered table-hover">
        ...
        if (isset($_POST['cari'])) {
          ...
          $sql="SELECT * FROM makanan WHERE makanan LIKE '%".$cari."%' OR asal LIKE '%".$cari."%' ORDER BY id ASC";
        } else {
        ...
        $query2 = "SELECT * FROM makanan WHERE makanan LIKE '%".$cari."%' OR asal LIKE '%".$cari."%' ORDER BY id ASC LIMIT $offset,$limit";
    ...
    <div class="row">
      <nav aria-label="Page navigation example" class="mx-auto">
        <ul class="pagination">
          ...
          ?>
          <li class="page-item"><a class="page-link" href="<?php echo "listmakanan.php?halaman=$sebelum"; ?>">Sebelumnya</a></li>
          <?php } ?>
          <?php
          for ($i=1; $i<=$jlh_halaman; $i++){
            echo "<li class=page-item><a class=page-link href=listmakanan.php?halaman=$i>$i</a></li>";
          }
          ?>
          <?php
          if ($halaman==5){
          ...
          ?>         
          <li class="page-item"><a class="page-link" href="<?php echo "listmakanan.php?halaman=$sesudah"; ?>">Selanjutnya</a></li>
          <?php } ?>
        </ul>
      </nav>
    </div>
