...
<head>
    ...
    <title>Perut Ikan Bumbu Kering Kayu</title>
   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">PERUT IKAN BUMBU KERING KAYU</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Maluku/perutikambumbukeringkayu.jpg" alt="Perut Ikan" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1/2 kg isi perut ikan, rebus lalu tiriskan</h5></li>
              <li><h5>2 sdm air asam jawa</h5></li>
              <li><h5>2 sdm kecap manis</h5></li>
              <li><h5>2 batang sereh, geprek</h5></li>
              <li><h5>1 batang kayu manis</h5></li>
              <li><h5>1 buah pekak (bunga lawang)</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu-halus :</h2>
            <ul type="disc">
              <li><h5>10 siung bawang merah</h5></li>
              <li><h5>3 siung bawang putih</h5></li>
              <li><h5>2 ruas jahe</h5></li>
              <li><h5>3 biji kenari / boleh diganti kemiri</h5></li>
              <li><h5>1 sdt ketumbar bubuk</h5></li>
              <li><h5>9 cabe merah keriting (boleh ditambahkan sesuai selera)</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
              <li><h5>Rebus perut ikan dengan daun salam, tiriskan.</h5></li>
              <li><h5>Siapkan bumbu halus.</h5></li>
              <li><h5>Tumis bumbu halus dan bumbu pelengkap lainnya, tumis hingga harum dan matang.</h5></li>
              <li><h5>Jika bumbu sudah harum, masukkan perut ikan yg sudah direbus, beri 100 ml air matang, garam dan gula, masak hingga air menyusut.</h5></li>
              <li><h5>Setelah air menyusut, masukkan kecap manis, air asam, koreksi rasa lalu masak kembali hingga kering, dan sajikan dengan nasi hangat.</h5></li>
              </ul>         
          </div>
        </div>    
    </section>
