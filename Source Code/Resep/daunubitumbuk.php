   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">DAUN UBI TUMBUK</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/daunubitumbuk.jpg" alt="Daun Ubi Tumbuk" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1 ikat daun singkong ambil bagian pucuknya</h5></li>
              <li><h5>1 buah kincung (kecombrang), belah 2</h5></li>
              <li><h5>Segenggam rimbang</h5></li>
              <li><h5>6 butir bawang merah</h5></li>
              <li><h5>3 siung bawang putih</h5></li>
              <li><h5>2 ruas jari jahe</h5></li>
              <li><h5>1 ruas jari kunyit</h5></li>
              <li><h5>1 ruas jari lengkuas geprek</h5></li>
              <li><h5>2 lembar daun salam</h5></li>
              <li><h5>1 batang serai ambil bagian putih geprek</h5></li>
              <li><h5>5 buah cabai rawit atau sesuai selera</h5></li>
              <li><h5>1 ons teri asin</h5></li>
              <li><h5>400 ml santan sedang</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Haluskan cabai, bawang merah, bawang putih, kunyit, jahe</h5></li>
            <li><h5>Setelah agak halus, tumbuk daun singkong dan kincung (kecombrang) bersama bumbu, tumbuk setengah halus sampai rata</h5></li>
            <li><h5>Panaskan air di panci, masukkan tumbukan daun singkong beserta bumbu dan teri asin</h5></li>
            <li><h5>Masukkan serai, daun salam dan lengkuas geprek</h5></li>
            <li><h5>Masak sampai mendidih, masukkan santan</h5></li>
            <li><h5>Terakhir koreksi rasa dengan gula dan garam</h5></li>
            <li><h5>Sajikan</h5></li>
            </ul>         
          </div>
        </div>    
