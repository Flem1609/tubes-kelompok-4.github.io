   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">AYAM AROHU</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Maluku/ayamaroha.jpg" alt="Ayam Arohu" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>6 pc Ayam</h5></li>
              <li><h5>3 ruas Jahe digeprek</h5></li>
              <li><h5>2 Sereh digeprek</h5></li>
              <li><h5>200 cc Santan</h5></li>
              <li><h5>Minyak utk menumis</h5></li>
              </ul>
              <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu-halus :</h2>
            <ul type="disc">
              <li><h5>5 Bawang merah</h5></li>
              <li><h5>3 Bawang putih</h5></li>
              <li><h5>1 sdm Kenari</h5></li>
              <li><h5>Secukupnya garam,merica</h5></li>
              </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
              <li><h5>Persiapkan semua bahan2nya.</h5></li>
              <li><h5>Tumis bahan bumbu halus sampai harum lalu masukan ayam aduk2 hingga berubah warna</h5></li>
              <li><h5>Tambahkan jahe,sereh dan santan. Masak hingga bumbu meresap, ayam matang dan kuah mengental</h5></li>
              <li><h5>Sajikan</h5></li>
              <li><h5></h5></li>
            </ul>         
          </div>
