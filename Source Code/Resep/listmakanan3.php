...
<head>
    ...
    <title>List Makanan Indonesia Bagian Tengah</title>
   ...
   <div class="wrapper d-flex align-items-stretch">
    <nav id="sidebar">
      <div class="p-4 pt-5">
          ...
          <center><span><b>Tamu</b></span></center>
          <ul class="list-unstyled components mb-5 mt-3">
            ...
            <ul class="collapse list-unstyled" id="homeSubmenu">
              <li>
                <a href="listmakanan1.php">Masakan Sumatera dan Jawa</a>
              </li>
              <li>
                <a href="listmakanan2.php">Masakan Kalimantan dan Sulawesi</a>
              </li>
              <li class="active">
                <a href="listmakanan3.php">Masakan Maluku dan Papua</a>
              </li>
            </ul>
            </li>
            <li>
              <a href="../Profil/tentangkami.html">Tentang Kami</a>
            </li>
            <li>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="nav navbar-nav ml-auto">
              ...
              <li class="nav-item">
                  <a class="nav-link" href="../Profil/tentangkami.html">Tentang Kami</a>
              </li>
              <li class="nav-item">
    ...
    <div class="container"> <div class=" text-center mt-5 ">
        <h2>List Makanan Maluku dan Papua</h2>
    </div>
    <div class="row mt-3">
    ...
    <table class="table table-bordered table-hover">
        ...
        if (isset($_POST['cari'])) {
          ...
          $sql="SELECT * FROM makanan WHERE makanan LIKE '%".$cari."%' AND asal LIKE 'Maluku dan Papua' ORDER BY id ASC";
        } else {
          $sql="SELECT * FROM makanan WHERE asal LIKE 'Maluku dan Papua' ORDER BY id ASC";
        }
        ...
        $query2 = "SELECT * FROM makanan WHERE makanan LIKE '%".$cari."%' AND asal LIKE 'Maluku dan Papua' ORDER BY id ASC LIMIT $offset,$limit";
        ...
        while ($data = mysqli_fetch_array($result2)) {
            ...
            <tr>
                ...
                <td><a href="<?php echo $data["link"] ?>"><?php echo $data["makanan"]; ?></a></td>
            </tr>
            </tbody>
            <?php
        }
    ...
    <div class="row">
      <nav aria-label="Page navigation example" class="mx-auto">
        <ul class="pagination">
          ...
          ?>
          <li class="page-item"><a class="page-link" href="<?php echo "listmakanan3.php?halaman=$sebelum"; ?>">Sebelumnya</a></li>
          <?php } ?>
          <?php
          for ($i=1; $i<=$jlh_halaman; $i++){
            echo "<li class=page-item><a class=page-link href=listmakanan3.php?halaman=$i>$i</a></li>";
          }
          ?>
        </ul>
      </nav>
      ...
      <div class="container text-center text-md-left mt-5" style="color: white;">
        <div class="row mt-3">
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
            <p>
              <a href="../Resep/listmakanan.php">Makanan Tradisional</a>
            </p>
            <p>
          ...
          <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
              <a href="../Saran/saran.html">Kolom Saran</a>
            </p>
            <p>
