   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">PEMPEK PALEMBANG</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/pempekpalembang.jpg" alt="Pempek Palembang" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>500 gram ikan tenggiri giling</h5></li>
              <li><h5>1 butir putih telur</h5></li>
              <li><h5>250 ml air</h5></li>
              <li><h5>1 sdm garam</h5></li>
              <li><h5>1 sdt penyedap jamur</h5></li>
              <li><h5>350 gr tepung sagu</h5></li>
              <li><h5>air secukupnya</h5></li>
              <li><h5>telur secukupnya</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Masukkan ikan ke dalam baskom, beri putih telur, air, garam dan penyedap jamur, aduk rata</h5></li>
            <li><h5>Masukkan tepung sagu, aduk rata kembali</h5></li>
            <li><h5>Ambil 150 gr adonan, beri isian 1 butir telur</h5></li>
            <li><h5>Masukkan adonan yang sudah dibentuk ke dalam air mendidih, masak hingga mengapung.</h5></li>
            <li><h5>Angkat dan tiriskan pempek.</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
