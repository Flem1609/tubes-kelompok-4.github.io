...
<head>
    ...
    <title>Ikan Bakar Manokwari</title>
   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">IKAN BAKAR MANOKWARI</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Papua/ikanbakarmanokwari.jpg" alt="Ikan Manokwari" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>450 gr ikan tongkol</h5></li>
              <li><h5>1 sdm air jeruk lemon </h5></li>
              <li><h5>½ sdm garam</h5></li>
              <li><h5>½ sdm merica</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan-bumbu :</h2>
            <ul type="disc">
              <li><h5>8 butir bawang merah</h5></li>
              <li><h5>8 butir cabe rawit merah</h5></li>
              <li><h5>½ sdt garam</h5></li>
              <li><h5>¼ sdt gula pasir</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
              <li><h5>Cuci hingga bersih ikan tongkol, lalu campur dengan air perasan jeruk nipis, garam dan merica. Aduk hingga rata lalu diamkan ikan selama 10-15 menit </h5></li>
              <li><h5>Siapkan alat panggang, lalu bakar ikan di atas bara api arang atau di panggangan hingga matang. Jaga agar jangan sampai gosong</h5></li>
              <li><h5>Haluskan bahan-bahan untuk membuat sambal</h5></li>
              <li><h5>Angkat ikan yang telah matang dari panggangan, lalu lumuri seluruh bagian ikan dengan bahan sambal yang telah dihaluskan</h5></li>
              <li><h5>Ikan bakar khas manokwari siap dihidangkan.</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
