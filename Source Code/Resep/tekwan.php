   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">TEKWAN</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI SUMATERA SELATAN</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/tekwan.jpg" alt="Tekwan" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>200 gram udang kupas, digiling atau dihancurkan sampai halus</h5></li>
              <li><h5>1/2 sdt gula</h5></li>
              <li><h5>1 sdt bawang putih halus</h5></li>
              <li><h5>1 buah putir telur</h5></li>
              <li><h5>1/2 sdt garam</h5></li>
              <li><h5>1 sdm tepung tapioka</h5></li>
              <li><h5>1/2 sdt kaldu bubuk</h5></li>
              <li><h5>2 sdm air es</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan-kuah :</h2>
            <ul type="disc">
              <li><h5>1,5 liter air</h5></li>
              <li><h5>1 sdt kaldu bubuk</h5></li>
              <li><h5>1/2 sdt gula</h5></li>
              <li><h5>5 siung bawang putih, digeprek</h5></li>
              <li><h5>1 sdt garam</h5></li>
              <li><h5>1/2 sdt lada bubuk</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Pelengkap :</h2>
            <ul type="disc">
              <li><h5>100 gram bihun, seduh dengan air hangat lalu tiriskan</h5></li>
              <li><h5>100 gram bengkuang, potong korek api</h5></li>
              <li><h5>100 gram jamur kuping, iris panjang lalu seduh dengan air hangat</h5></li>
              <li><h5>50 gram bawang goreng</h5></li>
              <li><h5>50 gram irisan daun bawang dan seledri</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Campur udang dengan semua bahan utama, aduk dan uleni</h5></li>
            <li><h5>Panaskan semua bahan kuah sampai mendidih</h5></li>
            <li><h5>Cetak adonan dengan sendok, bentuk bulat adonan. Masukkan ke kuah panas. Tunggu sampai mengapung</h5></li>
            <li><h5>Masukkan bengkuang, jamur kuping, dan kaldu bubuk</h5></li>
            <li><h5>Sajikan tekwan bersama bihun, beri taburan daun bawang, seledri, dan bawang goreng</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
