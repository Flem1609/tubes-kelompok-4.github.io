   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">LEMANG</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Kalimantan/lemang.jpg" alt="Lemang" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>Beras ketan 1 kg</h5></li>
              <li><h5>Santan kelapa 1 ltr</h5></li>
              <li><h5>Garam halus 1 sdt</h5></li>
              <li><h5>Daun pisang 1 tangkai</h5></li>
              <li><h5>Buluh bumbu 2 btg </h5></li>               
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Sebelum di masak, beras di cuci terlebih dahulu sampai bersih. Lalu tiriskan. Kemudian tambahkan garam, dan santan kelapa ke dalam beras yang sudah di cuci tadi dengan bersih.</h5></li>
            <li><h5>Sediakan bambu yang sudah di lapisi dengan daun pisang di setiap pinggiran dalam bambu, selanjutnya masukan beras ketan yang sudah di campur bumbu tadi dengan ukuran ¼ bagian bambu, kemudian di bagian atas di tutupi dengan menggunakan daun pisang.</h5></li>
            <li><h5>Untuk membakarnya, siapkan api kemudian bakar bambu yang sudah terisi beras ketan tadi sampai matang. Sesudah matang kemudian lemang di keluarkan dari bambu, dan selanjutnya potong-potong dan siap di sajikan.</h5></li>
            <li><h5>Enaknya memakan lemang ini dengan makanan yang berkuah, jadi akan terasa lebih nikmat juga menikmatinya. Selamat membaca dan semoga berhasil.</h5></li>  
            </ul>         
          </div>
        </div>    
    </section>
