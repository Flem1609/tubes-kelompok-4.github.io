...
<head>
    ...
    <title>Jemput Jemput Pisang</title>
   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">JEMPUT JEMPUT PISANG KHAS ANAMBAS</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/jemputjemputpisang.jpg" alt="Jemput Jemput Pisang" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>4 buah pisang kepok yang sudah kematangan</h5></li>
              <li><h5>130 gram tepung terigu</h5></li>
              <li><h5>4 sdm gula pasir</h5></li>
              <li><h5>1 sdt baking soda</h5></li>
              <li><h5>1 sdt garam</h5></li>
              <li><h5>Minyak untuk menggoreng</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Lumatkan pisang dgn garpu/whisk. Campurkan semua bahan. Tutup wadah, diamkan 30 menit</h5></li>
            <li><h5>Panaskan minyak, ambil 2 sdm adonan, goreng dengan api sedang sampai kecoklatan</h5></li>
            <li><h5>Angkat dan tiriskan. Siap disajikan</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
