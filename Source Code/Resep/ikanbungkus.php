   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">IKAN BUNGKUS</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Papua/ikanbungkus.jpg" alt="Ikan Bungkus" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="colmt-2">
            ...
            <ul type="disc">
              <li><h5>Cabai merah yang besar 3 buah dipotong bulat</h5></li>
              <li><h5>Belimbing wuluh 5 buah diiris tipis</h5></li>
              <li><h5>Ikan bandeng yang segar 650 gr dipotong-potong</h5></li>
              <li><h5>Daun salam 5 lembar</h5></li>
              <li><h5>Lengkuas yang diiris tipis 3 cm</h5></li>
              <li><h5>Cabai rawit yang dipotong-potong 20 buah</h5></li>
              <li><h5>Serai diiris halus 2 batang</h5></li>
              <li><h5>1 sendok makan garam</h5></li>
              <li><h5>Kaldu ayam bubuk 1 sendok teh</h5></li>
              <li><h5>Cabai hijau yang besar 3 buah diiris halus</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
              <li><h5>Haluskan bawang merah, bawang putih, cabe, jahe, kunyit</h5></li>
              <li><h5>Panakan minyak goreng, tumis bumbu halus beri garam, gula, merica, lengkuas, sere</h5></li>
              <li><h5>Beri air masukkan ikan tengiri tutup n tunggu sampai mendidih n kaldu ikan keluar beri perasan jeruk nipis, irisan tomat tutup kembali sampai tomatnya layu</h5></li>
              <li><h5>Setelah itu beri masako, daun kemangi n siap untuk disajikan....</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
