   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">ULILULIA</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;">RESEP MAKANAN DAERAH KHAS YANG BERASAL DARI PROVINSI GORONTALO</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sulawesi/ulilulia.jpg" alt="Ulilulia" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
        ...
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              ...
              <li><h5>1 sdt air jeruk nipis</h5></li>
              <li><h5>150 ml air</h5></li>
              <li><h5>2 sdm minyak goreng</h5></li>
              <li><h5>10 biji cabe merah keriting</h5></li>
              <li><h5>5 siung bawang merah</h5></li>
              <li><h5>3 siung bawang putih</h5></li>
              <li><h5>2 ruas lengkuas</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Siapkan bahan, bandeng cuci bersih lalu lumuri air jeruk nipis dan garam, diamkan 20 menit.</h5></li>
            <li><h5>Goreng bandeng, sisihkan.</h5></li>
            <li><h5>Panaskan minyak lalu tumis bawang merah hingga wangi. Masukkan bumbu halus, aduk lalu masukkan tomat, masak hingga tomat layu.</h5></li>
            <li><h5>Tambahkan air dan garam, masukkan ikan bandeng. Masak hingga bumbu meresap, beri air jeruk nipis, angkat.</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
