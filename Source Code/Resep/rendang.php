   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">RENDANG</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI SUMATERA BARAT</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/rendang.jpeg" alt="Rendang" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1 kg daging sapi</h5></li>
              <li><h5>Baby kentang</h5></li>
              <li><h5>2 lembar daun kunyit</h5></li>
              <li><h5>1 batang sereh</h5></li>
              <li><h5>4 lembar daun jeruk</h5></li>
              <li><h5>1 lembar daun salam</h5></li>
              <li><h5>1 ons cabai giling halus</h5></li>
              <li><h5>1 kg santan kental</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu-halus :</h2>
            <ul type="disc">
              <li><h5>10 bawang merah ukuran besar</h5></li>
              <li><h5>5 bawang putih</h5></li>
              <li><h5>Jahe (sebesar ibu jari)</h5></li>
              <li><h5>Lengkuas muda (sebesar ibu jari)</h5></li>
              <li><h5>1 paket rempah gulai/rendang (ketumbar, kapulaga, bunga pekak, cengkeh, kayu manis dan buah pala)</h5></li>
              <li><h5>Garam (sesuai selera)</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Masukkan semua bahan dalam satu wajan/kuali kecuali daging dan kentang</h5></li>
            <li><h5>Aduk sebentar hingga santan sedikit mendidih</h5></li>
            <li><h5>Masukkan daging</h5></li>
            <li><h5>Jika rendang sudah meletup-letup, masukan kentang</h5></li>
            <li><h5>Aduk lagi hingga rendang tanak (mengeluarkan minyak) dan rendang menghitam</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
