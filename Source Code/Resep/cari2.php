      ...
      <a href="#" class="img logo rounded-circle mb-3" style="background-image: url(https://img.pikbest.com/png-images/qiantu/hand-drawn-noodle-restaurant-chef-chef-illustration_2720597.png!c1024wm0/compress/true/progressive/true/format/webp/fw/1024);"></a>
          ...
          <ul class="list-unstyled components mb-5 mt-3">
            ...
            <ul class="collapse list-unstyled" id="homeSubmenu">
              ...
              <!-- Contohnya seperti <li class="active"> diatas tag <a>Masakan Kalimantan dan Sulawesi</a> -->
              <li>
    ...
    <div class="row">
      <nav aria-label="Page navigation example" class="mx-auto">
        <ul class="pagination">
          ...
          ?>
          <li class="page-item"><a class="page-link" href="<?php echo "cari2.php?halaman=$sebelum"; ?>">Sebelumnya</a></li>
          <?php } ?>
          <?php
          if ($halaman==2){
            echo "";
          ...
          ?>         
          <li class="page-item"><a class="page-link" href="<?php echo "cari2.php?halaman=$sesudah"; ?>">Selanjutnya</a></li>
          <?php } ?>
        </ul>
      </nav>
    </div>
