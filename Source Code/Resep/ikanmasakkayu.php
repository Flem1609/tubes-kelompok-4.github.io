   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">IKAN MASAK KAYU</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI MALUKU UTARA</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Maluku/ikanmasakkayu.jpg" alt="Ikan Masak Kayu" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1 kg Ikan Barakuda</h5></li>
              <li><h5>1 cangkir Air Asam</h5></li>
              <li><h5>1 buah jeruk nipis</h5></li>
              <li><h5>Secukupnya Air</h5></li>
              <li><h5>4 sdm Minyak goreng</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu-halus :</h2>
            <ul type="disc">
              <li><h5>8 Siung Bawang Merah</h5></li>
              <li><h5>5 Siung Bawang Putih</h5></li>
              <li><h5>4 Butir Kemiri (Sangrai)</h5></li>
              <li><h5>1 cm Lengkuas Muda</h5></li>
              <li><h5>1/2 sdt Kunyit halus</h5></li>
              <li><h5>1 cm Jahe</h5></li>
              <li><h5>1 sdt Ketumbar</h5></li>
              <li><h5>1 sdt Jintan</h5></li>
              <li><h5>1/4 sdt Lada Bubuk</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Rempah-pelengkap :</h2>
            <ul type="disc">
              <li><h5>1 Batang Serai (Geprek/Memarkan)</h5></li>
              <li><h5>1/2 sdt bubuk kayu manis</h5></li>
              <li><h5>3 Lembar Daun Salam</h5></li>
              <li><h5>2 Lembar Daun Jeruk</h5></li>
              <li><h5>4 Sdm Kecap Manis</h5></li>
              <li><h5>2 sdm Gula Merah (Sisir Halus/Lumerkan)</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
              <li><h5>Cuci bersih ikan yg telah dipotong-potong terlebih dahulu. Kemudian rendam ikan ke dalam air asam yg ditambahkan perasan jeruk nipis, selama kurang lebih 30 menit lalu sisihkan.</h5></li>
              <li><h5>Haluskan bumbu halus.</h5></li>
              <li><h5>Panaskan minyak dan tumis bumbu halus bersama kunyit dan aduk rata. Tumis hingga harum.</h5></li>
              <li><h5>Tambahkan air lalu aduk sampai rata.</h5></li>
              <li><h5>Masukkan ikan bersama semua air campuran asam dan jeruk ke dalam wajan. Masak ikan sampai matang sekitar 20 menit. Setelah ikan matang angkat dan sajikan segera</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
