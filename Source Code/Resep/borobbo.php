...
<head>
    ...
    <title>Barobbo / Bubur Jagung</title>
   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">BAROBBO / BUBUR JAGUNG</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sulawesi/barobbo.jpg" alt="Barobbo" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>4 buah jagung kuning, disisir</h5></li>
              <li><h5>1 genggam beras</h5></li>
              <li><h5>1/4 kg udang, kupas kulitnya</h5></li>
              <li><h5>2 ikat bayam</h5></li>
              <li><h5>2 ikat kangkung</h5></li>
              <li><h5>1 ikat kacang panjang</h5></li>
              <li><h5>1 ikat kemangi</h5></li>
              <li><h5>3 keping mie telur, diremas-remas hingga agak hancur</h5></li>
              <li><h5>Secukupnya Air</h5></li>
              <li><h5>Garam</h5></li>
              <li><h5>Kaldu bubuk</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu-halus :</h2>
            <ul type="disc">
              <li><h5>4 Bawang merah</h5></li>
              <li><h5>2 bawang putih</h5></li>
              <li><h5>1 sdt lada bubuk</h5></li>
            </ul>
            ...
            <ul type="disc">
              ...
              <li><h5>Sambal</h5></li>
              <li><h5>Perkedel jagung</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
              <li><h5>Siapkan semua bahan..Masak beras dan jagung yang telah disisir hingga lunak. Sering-sering diaduk biar tidak lengket.</h5></li>
              <li><h5>Tumis bumbu dan masukkan dalam panci barobbo.</h5></li>
              <li><h5>Masukkan udang dan mie. Biarkan hingga mie nya lunak.</h5></li>
              <li><h5>Lalu masukkan sayuran bayam, kangkung dan kacang panjang yang telah dicuci terlebih dahulu. </h5></li>
              <li><h5>Tambahkan garam dan kaldu bubuk. Tes rasa. Biarkan hingga meletup. Matikan kompor</h5></li>
              <li><h5>Masukkan dalam piring saji, beri tambahan sambal dan taburi bawang goreng. </h5></li>
              <li><h5>Niikmati bersama perkedel jagung. Jangan lupa cuci tangan dan berdo'a sebelum makan.</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
