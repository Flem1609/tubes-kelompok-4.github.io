   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">IKAN PALUMARA</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sulawesi/ikanpalumara.jpg" alt="Palumara" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>3 ekor ikan (lupa nama ikannya)</h5></li>
              <li><h5>3 siung bawang merah (iris tipis)</h5></li>
              <li><h5>3 siung bawang putih (iris tipis)</h5></li>
              <li><h5>5 cabe rawit (iris serong)</h5></li>
              <li><h5>1 cabe merah besar (iris serong)</h5></li>
              <li><h5>1 buah tomat (iris)</h5></li>
              <li><h5>1 batang sereh (digeprek)</h5></li>
              <li><h5>1 lembar daun salam</h5></li>
              <li><h5>1/2 sdt kunyit bubuk</h5></li>
              <li><h5>1 sdm asam jawa</h5></li>           
              <li><h5>Garam dan gula</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
            <li><h5>Tuangkan sedikit air ke asam jawa, remas-remas dan saring airnya ke wadah ikan. </h5></li>
            <li><h5>Lakukan hingga air asam menjadi bening. Tambahkan kunyit lalu sisihkan.</h5></li>
            <li><h5>Siapkan bumbu yang sudah diiris-iris.</h5></li>
            <li><h5>Panaskan minyak di wajan, masukkan duo bawang.</h5></li>
            <li><h5>Goreng hingga kering. Masukkan juga duo cabe, tomat, daun salam dan sereh.</h5></li>
            <li><h5>Masukkan ikan beserta asam jawa dan kunyit. Jika Anda rasa airnya terlalu sedikit, bisa ditambahkan.</h5></li>
            <li><h5>Masukkan garam dan gula. Biarkan mendidih agak lama dan bumbu meresap. Tes rasa dan sajikan.</h5></li>
