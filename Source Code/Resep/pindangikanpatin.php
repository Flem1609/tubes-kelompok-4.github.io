...
<head>
    ...
    <title>Pindang Ikan Patin</title>
   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">PINDANG IKAN PATIN</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/pindangikanpatin.jpg" alt="Pindang Ikan Patin" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan :</h2>
            <ul type="disc">
              <li><h5>1 kg ikan patin</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu-halus :</h2>
            <ul type="disc">
              <li><h5>10 buah cabai merah</h5></li>
              <li><h5>1 ruas jahe</h5></li>
              <li><h5>7 butir bawang merah</h5></li>
              <li><h5>1 ruas kunyit</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu-geprek :</h2>
            <ul type="disc">
              <li><h5>1 batang serai</h5></li>
              <li><h5>2 biji asam matang</h5></li>
              <li><h5>Gula dan garam secukupnya</h5></li>
              <li><h5>2 lembar daun salam</h5></li>
              <li><h5>2 lembar daun jeruk</h5></li>
              <li><h5>1 ruas lengkuas</h5></li>
              <li><h5>1 sdm terasi Palembang</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
            <li><h5>Masukkan bumbu halus ke panci. Tambahkan bumbu geprek dan tuang air, aduk rata</h5></li>
            <li><h5>Masukkan gula, garam, dan potongan ikan ke panci. Masak sampai ikan matang</h5></li>
            <li><h5>Angkat dan siap disajikan</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
