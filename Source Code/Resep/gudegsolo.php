   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">GUDEG SOLO</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;"> RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI JAWA TENGAH</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Jawa/gudegsolo.jpg" alt="Gudeg Solo" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1 kg nangka muda, potong kotak</h5></li>
              <li><h5>300-400 gr gula merah, sisir</h5></li>
              <li><h5>4 batang serai, geprek</h5></li>
              <li><h5>4 ruas lengkuas, geprek</h5></li>
              <li><h5>5 lembar daun salam</h5></li>
              <li><h5>4 lembar daun jeruk</h5></li>
              <li><h5>1 liter santan cair</h5></li>
              <li><h5>700 ml air kelapa</h5></li>
              <li><h5>1 liter santan kental</h5></li>
              <li><h5>Garam secukupnya</h5></li>
              <li><h5>3 lembar daun jati</h5></li>
              <li><h5>Telur rebus</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Tata daun jati di dasar panci, lalu masukan nangka muda dan semua bumbu-bumbu. Tuang santan cair dan juga air kelapa. Kemudian tutup kembali dengan daun jati dan tutup panci, masak hingga kuah sedikit menyusut (pakai api kecil).</h5></li>
            <li><h5>Setelah kuah sedikit menyusut, tambahkan gula merah, garam dan santan kental. Tutup kembali dengan daun jati dan tutup panci, lanjutkan memasak dengan api kecil</h5></li>
            <li><h5>Koreksi rasa. Terakhir tambahkan telur rebus, kemudian tutup panci kembali, lanjut masak gudeg hingga matang dan benar-benar kering (api kecil) selama 8-10 jam. Sajikan Gudeg beserta lauk pendamping.</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
