   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">SAYUR AYAM KUTAI</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Kalimantan/sayurasamkutai.jpg" alt="Sayur Asam" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
                <li><h5>300 gram talas, potong 2x2x2 cm</h5></li>
                <li><h5>1 ikat kangkung, disiangi</h5></li>
                <li><h5>100 gram jantung pisang, iris, rebus hingga setengah matang</h5></li>
                <li><h5>1 ekor ikan gabus, potong tebal 2 cm</h5></li>
                <li><h5>5 buah asam sunti</h5></li>
                <li><h5>500 ml air</h5></li>
                <li><h5>5 butir bawang merah, iris tipis</h5></li>
                <li><h5>1 sendok makan garam</h5></li>
                <li><h5>1/2 sendok teh gula pasir</h5></li>              
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
              <li><h5>Lumuri ikan gabus dengan 1/2 sendok teh air jeruk nipis dan 1 sendok teh garam. Diamkan 15 menit.</h5></li>
              <li><h5>Didihkan air. Tambahkan bawang merah sampai harum.</h5></li>
              <li><h5>Masukkan talas. Masak sampai setengah matang. Tambahkan ikan gabus dan asamsunti. Aduk rata.</h5></li>
              <li><h5>Masukkan kangkung dan jantung pisang. Masak sampai matang.</h5></li>              
            </ul>         
          </div>
        </div>    
    </section>
