   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">SINONGGI KENDARI</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI SULAWESI TENGGARA</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sulawesi/sinonggi.jpg" alt="Sinonggi" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1/2 litter Sagu</h5></li>
              <li><h5>Ikan (terserah ikan apa)</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu-ikan :</h2>
            <ul type="disc">
              <li><h5>3 siung bawang putih</h5></li>
              <li><h5>4 siung bawang merah</h5></li>
              <li><h5>Tomat</h5></li>
              <li><h5>Daun serei</h5></li>
              <li><h5>Kunyit</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan-kangkung :</h2>
            <ul type="disc">
              <li><h5>3 siung Bawang putih</h5></li>
              <li><h5>Tomat</h5></li>
              <li><h5>Kangkung</h5></li>
              <li><h5>3 siung Bawang merah</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
              <li><h5>Tumis ikan. Haluskan bawang putih dan bawang merah. Masukkan tomat daun serei, masukkan air, lalu masukkan ikan dan kunyit. Tutup. Setelh mendidih masukkan massako. Tes rasa. Setelah matang sisihkan ikan.</h5></li>
              <li><h5>Tumis kangkung....masukkan bawang merah dan putih, lalu tomat. Masukkan kangkung yg sudah dicuci bersih, tunggu hingga layu, msukkan masako. Tes rasa tunggu hingga matang. Sisihkan</h5></li>
              <li><h5>Masak air untuk sagu... Sambil menunggu air matang. Ambil wadah masukkan sagu dengan air, saring sagu (pake saringan kelapa) agar kotoran sagux hilang. Diamkan sampe mengendap...</h5></li>
              <li><h5>Setelah mengendap buang airnya, sisakan sedikit saja, lalu aduk2... Tuang air mendidih.....aduk2 sagu sampai mengental...jangan terlalu bxk airx, agar tidak encer....</h5></li>
              <li><h5>Siap dimakan. (pake sambal terasi juga supya sedap 😋) tdk ditulis resepnya kepanjangan 😅</h5></li>
              <li><h5>Taraa siap disantap.</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
