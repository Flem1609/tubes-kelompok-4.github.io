   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">MIE LENDIR</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI KEPULAUAN RIAU</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/mielendir.jpg" alt="Mie Lendir" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>500 gr mie kuning basah</h5></li>
              <li><h5>100 gr kacang tanah</h5></li>
              <li><h5>200 gr kentang</h5></li>
              <li><h5>100 gr gula merah</h5></li>
              <li><h5>Irisan seledri, bawang goreng, cabe rawit</h5></li>
              <li><h5>Telor rebus</h5></li>
              <li><h5>Toge rebus</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu-halus :</h2>
            <ul type="disc">
              <li><h5>5 cabe merah</h5></li>
              <li><h5>4 bawang putih</h5></li>
              <li><h5>8 bawang merah</h5></li>
              <li><h5>Sereh, daun salam</h5></li>
              <li><h5>Lada bubuk-garam-gula</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Rebus mie kuning basah, tiriskan</h5></li>
            <li><h5>Toge bisa direbus sebentar beberapa detik atau disiram air panas mendidih saja juga udah cukup</h5></li>
            <li><h5>Goreng kacang tanah, lalu haluskan/blender</h5></li>
            <li><h5>Rebus kentang, lalu haluskan/blender</h5></li>
            <li><h5>Tumis bumbu halus beserta sereh dan daun salam, beri sedikit air, kurang lebih 100ml, lalu masukkan kacang dan kentang yg sudah dihaluskan. Tumis sampai tercampur rata, lalu tambahkan air sekitar 500-700ml</h5></li>
            <li><h5>Tambahkan gula merah yg telah disisir/dihaluskan, aduk rata, tambahkan lada, garam dan gula. Jika mau ditambah 1sdt kaldu ayam knorr</h5></li>
            <li><h5>Aduk terus hingga mengental, tes rasa, kalau sudah mengental matikan api</h5></li>
            <li><h5>Tata mie kuning dan toge di piring, siram dengan kuah kacang, taburkan seledri dan bawang goreng, tambahkan irisan cabe rawit dan telor rebus</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
