   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">IKAN PARENDE</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sulawesi/ikanparende.jpg" alt="Ikan Parende" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>500 gr ikan kakap fillet</h5></li>
              <li><h5>1 jeruk nipis</h5></li>
              <li><h5>150 ml air asam jawa</h5></li>
              <li><h5>2 batang serai, geprek</h5></li>
              <li><h5>Daun salam, daun jeruk</h5></li>
              <li><h5>2 genggam daun kemangi</h5></li>
              <li><h5>1 buah tomat ijo</h5></li>
              <li><h5>5 buah cabe rawit merah</h5></li>
              <li><h5>Lada bubuk</h5></li>
              <li><h5>Secukuonya garam dan kaldu jamur</h5></li>
              <li><h5>Sedikit minyak goreng untuk tumis</h5></li>
              <li><h5>2 liter air untuk kuah</h5></li>
            </ul>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
            <li><h5>Potong2 ayam, ukuran-nya sesuai selera saja .</h5></li>
            <li><h5>Setelah itu cuci bersih, kemudian lumuri perasan jeruk nipis, diamkan sekitar 10 menitan.</h5></li>
            <li><h5>Kemudian cuci bersih lagi,trus lumuri lagi dengan air asam Jawa, sisihkan.</h5></li>
            <li><h5>Setelah itu tumis bumbu halus hingga harum kemudian masukkan bumbu Cemplung.....</h5></li>
            <li><h5>Lalu masukkan ayamnya,kasih air hingga ayamnya tenggelam. Terus masukkan garam, penyedap rasa&gula pasir secukupnya,kemudian masak hingga ayam-nya empuk & airnya menyusut.</h5></li>
            <li><h5>Koreksi rasa.</h5></li>
            <li><h5>Setelah matang angkat,tata dipiring,taburi bawang goreng &siap dinikmati 👍👍👍</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
