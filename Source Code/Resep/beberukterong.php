   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">BEBERUK TERONG</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI NUSA TENGGARA BARAT</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Bali dan Sekitarnya/beberukterong.jpg" alt="Beberuk Terong" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>5 buah terong bulat hijau, potong tipis-tipis</h5></li>
              <li><h5>4 lenjer kacang panjang, potong kecil-kecil</h5></li>
              <li><h5>1 siung bawang merah, iris tipis</h5></li>
              <li><h5>1 sdt air jeruk purut</h5></li>
              <li><h5>3 sdm minyak panas</h5></li>
              <li><h5>4 buah cabai keriting</h5></li>
              <li><h5>3 buah cabai rawit/secukupnya</h5></li>
              <li><h5>1 siung bawang putih</h5></li>
              <li><h5>3 siung bawang merah</h5></li>
              <li><h5>2 ruas kencur</h5></li>
              <li><h5>1 sdt terasi, bakar</h5></li>
              <li><h5>1 sdt gula</h5></li>
              <li><h5>1 sdt garam secukupnya</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Ulek halus bumbu sambal. Panaskan minyak dan tuang ke dalam bumbu sambal, aduk rata. Sisihkan.</h5></li>
            <li><h5>Beri perasan air jeruk.</h5></li>
            <li><h5>Masukkan terong dan kacang panjang aduk rata.</h5></li>
            <li><h5>Sajikan dengan taburan bawang goreng.</h5></li>
