   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">BALADO JENGKOL</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVNISI SUMATERA BARAT</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/baladojengkol.png" alt="Balado Jengkol" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>250 gr jengkol, belah dua</h5></li>
              <li><h5>2 buah kentang kupas, potong-potong</h5></li>
              <li><h5>50 gr teri</h5></li>
              <li><h5>1 buah tomat, iris</h5></li>
              <li><h5>Minyak dan garam secukupnya</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu-halus :</h2>
            <ul type="disc">
              <li><h5>100 gr cabai keriting</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
            <li><h5>Goreng kentang sampai matang lalu tiriskan</h5></li>
            <li><h5>Goreng jengkol, lalu masukkan ke mangkok berisi air kemudian tiriskan lalu geprek</h5></li>
            <li><h5>Goreng teri sampai matang, tiriskan</h5></li>
            <li><h5>Tumis bumbu halus dan tomat sampai matang, beri garam secukupnya</h5></li>
            <li><h5>Icip rasa, matikan api. Tuang bahan-bahan yang sudah digoreng ke tumisan cabai. Aduk rata</h5></li>
            <li><h5>Sajikan dengan nasi hangat</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
