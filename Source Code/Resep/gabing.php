   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">GABING</h1>
          <br>
          <h2 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI LAMPUNG</h2>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/gabing.jpg" alt="Gabing" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>Batang kelapa muda</h5></li>
              <li><h5>Santan (santal kental dari kelapa)</h5></li>
              <li><h5>Bumbu opor</h5></li>
              <li><h5>7 buah cabe rawit</h5></li>
              <li><h5>¼ udang</h5></li>
              <li><h5>1 gram cempokak</h5></li>            
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Pertama batang kelapa muda di potong dengan ukuran sedang (sesuai selera) kalau saya di iris tipis-tipis.</h5></li>
            <li><h5>Lalu rebus batang kelapa muda yang telah di iris tipis sampai mendidih (empuk). Angkat lalu tiriskan.</h5></li>
            <li><h5>Kemudian masukkan bumbu opor dan santan, tambahkan cabe rawit utuh, udang dan cempokak. Masak hingga matang.</h5></li>
            <li><h5>Lalu sajikan di mangkok.</h5></li>
          </div>
        </div>    
    </section>
    <br>
