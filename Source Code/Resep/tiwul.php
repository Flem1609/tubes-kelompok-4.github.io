   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">TIWUL</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;">RESEP MAKANAN DAERAH KHAS YANG BERASAL DARI PROVINSI YOGYAKARTA</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Jawa/tiwul.jpg" alt="Tiwul" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>350 gram singkong. Kupas dan jemur selama 3-4 hari</h5></li>
              <li><h5>1 gelas air matang</h5></li>
              <li><h5>150 gram gula merah. Disisir halus</h5></li>
              <li><h5>200 gram kelapa parut</h5></li>
              <li><h5>2 lembar daun pandan. Ikat simpul</h5></li>
              <li><h5>1 tangkai daun pisang. Ambil daunnya</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
            <li><h5>Tumbuk kasar singkong yang sudah kering (gaplek) sambil dipercik-percikkan air. Tumbuk hingga gaplek membentuk butiran-butiran kecil.</h5></li>
            <li><h5>Tambahkan gula merah pada gaplek kemudian dibungkus seperti membungkus pepes ikan dengan menggunakan daun pisang. Kukus gaplek hingga matang</h5></li>
            <li><h5>Buat taburan kelapa untuk gaplek . Caranya: kukus parutan kelapa bersama dengan daun pandan dan garam selama 15 menit.</h5></li>
            <li><h5>Angkat dan taburi pada tiwul.</h5></li>
            <li><h5>Tiwul siap disajikan</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
