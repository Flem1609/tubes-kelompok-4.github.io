   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">IKAN CUKA KHAS RIAU</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/ikancukakhasriau.jpeg" alt="Ikan Cuka" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>5 potong ikan tuna fillet</h5></li>
              <li><h5>1 buah jeruk nipis</h5></li>
              <li><h5>Garam</h5></li>
              <li><h5>Air</h5></li>
              <li><h5>Bahan 5</h5></li>
              <li><h5>dan seterusnya ....</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu :</h2>
            <ul type="disc">
              <li><h5>6 siung bawang merah, iris halus</h5></li>
              <li><h5>2 siung bawang putih, iris halus</h5></li>
              <li><h5>7 buah cabai merah keriting ,iris serong</h5></li>
              <li><h5>1/2 buah tomat merah potong kasar</h5></li>
              <li><h5>1 batang serai geprek</h5></li>
              <li><h5>1 ruas kecil jahe geprek atau iris-iris</h5></li>
              <li><h5>2 lembar daun jeruk</h5></li>
              <li><h5>Gula merah, garam, dan lada bubuk</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Cuci bersih ikan, lalu beri perasan air jeruk nipis dan garam, diamkan selama 10 menit</h5></li>
            <li><h5>Goreng ikan sampai kuning kecokelatan, angkat dan sisihkan</h5></li>
            <li><h5>Tumis bawang merah dan bawang putih sampai harum, lalu masukkan tomat, cabai, jahe, serai, dan daun jeruk, tumis lagi hingga harum dan wangi</h5></li>
            <li><h5>Masukkan ikan goreng, aduk-aduk lalu tuangi air sampai menutupi ikan, beri gula merah, garam, perasan air jeruk nipis sekitar 1 sdm, dan lada bubuk, aduk-aduk dan masak sampai air menyusut</h5></li>
            <li><h5>Tes rasa, lalu angkat dan siap disajikan bersama nasi hangat</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
