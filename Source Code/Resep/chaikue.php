...
<body style="background-color: rgb(235, 235, 235);">
   ...
   <!-- Sidebar --> 
    ...
    <nav id="sidebar">
      <div class="p-4 pt-5">
          <a href="#" class="img logo rounded-circle mb-3" style="background-image: url(https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png);"></a>
          ...
          <ul class="list-unstyled components mb-5 mt-3">
            ...
            <ul class="collapse list-unstyled" id="homeSubmenu">
              ...
              <li class="active">
                <a href="#">Masakan Sumatera dan Jawa</a>
              </li>
              <li>
                <a href="#">Masakan Kalimantan dan Sulawesi</a>
              </li>
              <li>
                <a href="#">Masakan Maluku dan Papua</a>
              </li>
            </ul>
            </li>
            <li>
            ...
            <ul class="collapse list-unstyled" id="pageSubmenu">
              ...
              <li>
                <a href="komentar.php">Kolom Komentar</a>
              </li>
              </ul>
            </li>
            <li>
            ...
            <li>
              <a href="sarankritik.php">Saran dan Kritikan</a>
            </li>
          </ul>
      </div>
    </nav>
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">CHAI KUE</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI KALIMANTAN BARAT</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Kalimantan/chaikue.jpg" alt="Chai Kue" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>200 gr tepung beras</h5></li>
              <li><h5>50 gr tepung sagu atau tapioka</h5></li>
              <li><h5>350 ml air panas</h5></li>
              <li><h5>Seperempat sendok teh garam</h5></li>
              <li><h5>2 sendok teh minyak sayur</h5></li>
              <li><h5>5 buah cabe rawit</h5></li>
              <li><h5>6 siung bawang putih, cincang halus</h5></li>
              <li><h5>500 gr bengkuang</h5></li>
              <li><h5>50 gr udang ebi </h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
            <li><h5>Tumis bawang putih (kira-kira satu sendok saja) dan udang ebi sampai harum, masukkan bengkuang lalu tambahkan sedikit air agar tidak terlalu kering. Tambahkan garam dan gula secukupnya. Aduk hingga merata. Masak hingga bengkuang sudah terlihat layu atau berwarna kecoklatan.</h5></li>
            <li><h5>Kulit: Masukkan tepung beras, tepung sagu, garam kedalam wadah lalu tambahkan air panas, aduk hingga merata. Tambahkan minyak sayur.</h5></li>
            <li><h5>Pindahkan adonan tepung kedalam panci yang telah dipanaskan di atas kompor. Aduk terus, masak sampai adonan mengental.</h5></li>
            <li><h5>Tuang adonan di atas talenan kemudian uleni sampai kalis.</h5></li>
            <li><h5>Ambil sedikit adonan lalu pipihkan dan isi dengan bengkoang. Ulangi sampai adonan habis.</h5></li>
            <li><h5>Siapkan alat kukusan yang sudah di panaskan terlebih dahulu. Kukus selama 10 menit.</h5></li>
            <li><h5>Setelah matang bubuhi atasnya dengan bawang goreng. </h5></li>          
            </ul>         
          </div>
        </div>    
    </section>
