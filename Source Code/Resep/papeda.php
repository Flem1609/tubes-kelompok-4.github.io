   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">PAPEDA</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;">RESEP MAKANAN DAERAH KHAS YANG BERASAL DARI PROVINSI PAPUA</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Papua/papeda.jpg" alt="Papeda" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1/4 tepung sagu</h5></li>
              <li><h5>Sejumput garam</h5></li>
              <li><h5>Kaldu ayam sejumput (sy pake royko ayam sachet)</h5></li>
              <li><h5>4 gelas air</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
              <li><h5>Didihkan 3 gelas air</h5></li>
              <li><h5>Campur tepung sagu,kaldu,garam,dan bwng putih yg telah di blender halus dgn 1 gelas air,aduk di mangkok</h5></li>
              <li><h5>Perlahan tuang cairan sagu ke air mendidih aduh terus sampe meletup-letup</h5></li></ul>
              <li><h5>Angkat sajikan (dapat di sajikan dengan ikan kuah kuning atau gulai ayam)</h5></li>        
          </div>
        </div>    
    </section>
    <br>
