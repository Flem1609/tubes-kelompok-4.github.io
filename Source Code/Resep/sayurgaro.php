   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">SAYUR GARO TERNATE</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Maluku/sayurgaro.jpg" alt="Sayur Garo" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>Sayur garo</h5></li>
              <li><h5>Ikan teri</h5></li>
            </ul>
            ...
            <ul type="disc">
              ...
              <li><h5>1/2 tomat</h5></li>
              <li><h5>15 cabe merah keriting </h5></li>
              <li><h5>10 cabe rawit </h5></li>
              <li><h5>1 sdt terasi</h5></li>
              <li><h5>secukupnya gula, garam, penyedap rasa, air</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
              <li><h5>Cuci bersih sayur garo, tiriskan</h5></li>
              <li><h5>Goreng ikan teri sampai matang, tiriskan </h5></li>
              <li><h5>Tumis bumbu halus sampai harum dengan minyak agak banyak</h5></li>
              <li><h5>Masukkan ikan teri, gula, garam, penyedap rasa.</h5></li>
              <li><h5>Masukkan sayur garo, aduk rata, beri air sedikit, masak sampai sayur layu dan koreksi rasa</h5></li>
              <li><h5>Sajikan dengan ikan goreng sambal dabu, menu khas ternate.</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
