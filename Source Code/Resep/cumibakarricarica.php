...
<head>
    ...
    <title>Cumi Bakar Bumbu Rica-rica</title>
   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">CUMI BAKAR BUMBU RICA-RICA</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI SULAWESI UTARA</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sulawesi/cumibakarbumburicarica.jpg" alt="Cumi Bakar Bumbu Rica-Rica Khas Manado" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>6 ekor cumi-cumi segar</h5></li>
              <li><h5>3 siung bawang putih, iris</h5></li>
              <li><h5>5 siung bawang merah, iris</h5></li>
              <li><h5>2 buah tomat, potong kecil-kecil</h5></li>
              ...
              <li><h5>2 batang sereh, iris</h5></li>
              <li><h5>3 cm jahe 2 lembar daun salam</h5></li>
              <li><h5>1 sdt gula 1 buah jeruk nipis, peras ambil airnya</h5></li>
              <li><h5>1 sdt garam 1/2 sdt lada hitam</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Bersihkan cumi, kupas, lepas, lalu potong kecil kepala cumi, campur dengan irisan bawang merah, irisan bawang putih dan potongan tomat, lalu aduk dengan bumbu tambahan, garam dan gula secukupnya</h5></li>
            <li><h5>Kemudian isi campuran ke dalam cumi-cumi, tutup dengan lidi agar isi tidak keluar<h5></li>
            <li><h5>Haluskan bumbu, bawang putih, bawang merah, cabai merah, jahe dan garam</h5></li>
            <li><h5>Siapkan wajan, panaskan, masukkan cumi-cumi, lalu siram dengan bumbu halus, air kaldu, sereh, daun salam, daun pandan dan perasan jeruk nipis, tutup wajan dan masak selama 5 menit</h5></li>
            <li><h5>Sajikan.</h5></li>
            </ul>         
          </div>
        </div>    
