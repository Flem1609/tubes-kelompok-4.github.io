   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">SOTO MEDAN</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI SUMATERA UTARA</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/sotomedan.jpg" alt="Soto Medan" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1 kg ayam potong kecil, cuci, ungkep diambil aja, sisihkan</h5></li>
              <li><h5>1 buah wortel, potong dadu</h5></li>
              <li><h5>Santan dari 1 butir kelapa (pisahkan santan encer dan kentalnya)</h5></li>
              <li><h5>3 batang serai digeprek</h5></li>
              <li><h5>3 ruas jari lengkuas digeprek</h5></li>
              <li><h5>5 buah daun jeruk remas</h5></li>
              <li><h5>2 batang daun bawang, iris</h5></li>
              <li><h5>3 batang daun seledri, iris</h5></li>
              <li><h5>Bawang goreng secukupnya</h5></li>
              <li><h5>Gula</h5></li>
              <li><h5>Garam</h5></li>
              <li><h5>Minyak untuk menumis</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu-halus :</h2>
            <ul type="disc">
              <li><h5>12 buah bawang merah</h5></li>
              <li><h5>4 buah bawang putih</h5></li>
              <li><h5>1 ruas jari jahe</h5></li>
              <li><h5>2 ruas jari kunyit, bakat</h5></li>
              <li><h5>4 buah kemiri, sangrai</h5></li>
              <li><h5>1 sdm ketumbar, sangrai</h5></li>
              <li><h5>1 sdm merica</h5></li>
              <li><h5>1/2 bulatan buah pala</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Rempah-rempah :</h2>
            <ul type="disc">
              <li><h5>3 buah kayu manis</h5></li>
              <li><h5>3 buah bunga lawang</h5></li>
              <li><h5>4 buah kapulaga</h5></li>
              <li><h5>5 buah cengkeh</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Panaskan minyak goreng</h5></li>
            <li><h5>Masukkan bumbu yang sudah dihaluskan, tumis hingga bumbu harum</h5></li>
            <li><h5>Masukkan rempah-rempah, serai, laos dan daun jeruk, aduk kembali hingga harum</h5></li>
            <li><h5>Masukkan wortel dan ayam, serta santan encer, aduk hingga rata, tutup panci agar semua bumbu meresap</h5></li>
            <li><h5>Masukkan santan kental, sambil terus diaduk aduk agar santan tidak pecah</h5></li>
            <li><h5>Tambahkan daun bawang, gula, dan garam, koreksi rasa</h5></li>
            <li><h5>Terus aduk perlahan hingga soto mendidih</h5></li>
            <li><h5>Matikan api</h5></li>
            <li><h5>Taburi daun seledri, dan bawang goreng</h5></li>
            <li><h5>Siap disajikan dengan sepiring nasi dan sambal kecap</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
