   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">SUP GANGAN</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;">RESEP MAKANAN DAERAH KHAS YANG BERASAL DARI PROVINSI BANGKA BEITUNG</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/supgangan.jpg" alt="Sup Gangan" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>Bawang merah</h5></li>
                <li><h5>Air</h5></li>
                <li><h5>Ikan segar (sesuai selera)</h5></li>
                <li><h5>Butir kemiri</h5></li>
                <li><h5>Bawang putih</h5></li>
                <li><h5>Kunyit</h5></li>
                <li><h5>Lengkuas</h5></li>
                <li><h5>Cabe rawit</h5></li>
                <li><h5>Jahe dan serai (digunakan bila memakai ikan yang amis, boleh juga tidak digunakan)</h5></li>
                <li><h5>Nanas setengah matang, kupas, potong menjadi dadu</h5></li>
                <li><h5>Terasi udang</h5></li>
                <li><h5>Secukupnya asam jawa</h5></li>
                <li><h5>Secukupnya garam dan gula</h5></li>               
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Bersihkan ikan. Potong sesuai selera. Campurkan dengan jeruk nipis atau asam dan garam. Diamkan 15 menit.</h5></li>
            <li><h5>Didihkan air.</h5></li>
            <li><h5>Haluskan bawang merah, bawang putih, cabe, kemiri, kunyit, lengkuas, terasi dan jahe (bila digunakan).</h5></li>
            <li><h5>Masukkan bumbu ke dalam air yang sudah mendidih. Didihkan bumbu selama 5 menit.</h5></li>
            <li><h5>Masukkan ikan tunggu hingga mendidih. Masukkan nanas. Asam jawa, garam, dan gula. Tunggu hingga mendidih. Cicipi rasanya. Didihkan lagi 5 menit. Matikan api.</h5></li>
            <li><h5>Sajikan</h5></li>  
            </ul>         
          </div>
        </div>    
