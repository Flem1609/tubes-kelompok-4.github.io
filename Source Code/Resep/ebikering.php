   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">EBI KERING</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sulawesi/ebikering.jpg" alt="Ebi Kering" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1/2 kg ebi</h5></li>
              <li><h5>4 bh cabai merah keriting</h5></li>
              <li><h5>3 lembar daun jeruk</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu-halus :</h2>
            <ul type="disc">
              <li><h5>3 bh bawang putih</h5></li>
              <li><h5>5 bh bawang merah</h5></li>
              <li><h5>2 bh gula merah</h5></li>
              <li><h5>2 sdt garam</h5></li>
              <li><h5>3 sdt gula pasir</h5></li>
              <li><h5>Secukupnya air</h5></li>
              <li><h5>Secukupnya minyak</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
              <li><h5>Goreng Ebi Hingga Matang Supaya Tahan Lama</h5></li>
              <li><h5>Haluskan Bumbu Bawang Merah, Putih, Gula, Garam</h5></li>
              <li><h5>Tumis Bumbu Halus Dengan Air Secukupnya</h5></li>
              <li><h5>Masukkan Cabai Dengan Daun Jeruk, Lalu Masukkan Ebi Yang Sudah Digoreng</h5></li>
              <li><h5>Tunggu Hingga Airnya Hilang</h5></li>
              <li><h5>Angkat Dan Sajikan</h5></li>
              <li><h5>Tambah Dengan Nasi Panas Sangat Cocok</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
