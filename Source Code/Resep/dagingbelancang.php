   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">Daging Belancang</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI NTT</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Bali dan Sekitarnya/dagingbelancang.jpg" alt="Daging Belancang" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
            <li><h5>500 gr daging sapi</h5></li>
              <li><h5>Secukupnya air untuk merebus</h5></li>
              <li><h5>1 btg daun bawang, potong potong 3 cm</h5></li>
              <li><h5>1/2 sdm kecap manis</h5></li>
              <li><h5>1 sdm air asam jawa</h5></li>
              <li><h5>Minyak goreng secukupnya</h5></li>
              <li><h5>3 siung bawang merah</h5></li>
              <li><h5>1 siung bawang putih</h5></li>
              <li><h5>1/2 sdt terasi</h5></li>
              <li><h5>1 sdt gula merah</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
            <li><h5>Rebus daging sapi sampai empuk. Angkat. Potong kecil kecil</h5></li>
            <li><h5>Panaskan secukupnya minyak goreng. Goreng potongan daging sapi sampai kering. Angkat. Tiriskan. Sisihkan dahulu</h5></li>
            <li><h5>Siapkan bumbu halus dan bahan lainnya</h5></li>
            <li><h5>Haluskan bumbu halus dengan ulekan, kemudian tumis dengan 1 sdm minyak goreng sampai harum</h5></li>
            <li><h5>Masukkan potongan daun bawang, kecap manis dan air asam jawa. Aduk rata.</h5></li>
            <li><h5>Terakhir masukkan daging sapi goreng. Aduk rata dan masak sampai bumbu meresap. Angkat. Sajikan.</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
