   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">KERAK TELOR</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Jawa/keraktelor.jpg" alt="Kerak Telor" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan-bubuk kelapa rebon :</h2>
            <ul type="disc">
              <li><h5>1/2 butir kelapa parut (sangrai hingga kering)</h5></li>
              <li><h5>2 sdm udang rebon goreng</h5></li>
              <li><h5>1 sdm gula pasir</h5></li>
              <li><h5>1/2 sdt kaldu jamur bubuk</h5></li>
              <li><h5>1 bungkus kecil Bon Cabe</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan-utama :</h2>
            <ul type="disc">
              <li><h5>1 butir telur</h5></li>
              <li><h5>1/2 sdt bumbu putih (bawang merah dan bawang putih)</h5></li>
              <li><h5>2-3 sdm nasi putih</h5></li>
              <li><h5>Sejumput garam, lada, dan kaldu bubuk</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
            <li><h5>Buat bubuk kelapa rebon dengan cara sangrai kelapa parut hingga garing dan berwarna kecoklatan, lalu haluskan bersama udang rebon yang sudah digoreng, gula, garam, kaldu, dan bubuk Bon Cabe. Saat menghaluskan, jangan terlalu ditekan agar tidak keluar minyak. Sisihkan.</h5></li>
            <li><h5>Kocok telur, nasi, garam, lada, kaldu, bumbu putih, dan 2 sdt bubuk kelapa rebon hingga rata.</h5></li>
            <li><h5>Tuang ke dalam teflon, ratakan, dan masak hingga bawahnya agak gosong dan berkerak. Balik dan lakukan juga hingga agak gosong. Angkat.</h5></li>
            <li><h5>Taburi dengan 2 sdt kelapa rebon dan 1 sdt bawang goreng.</h5></li>
            <li><h5>Kerak telor pun siap dinikmati selagi hangat</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
    ...
    <div class="row">
      <div class="col">
          <div class="card-deck">
            <div class="card mb-4">
            <a href="bikaambon.php"><img src="Gambar/Homepage/bikaambon.jpg" class="card-img-top" alt="..."></a>
              <div class="card-body">
                  ...
                  <a class="btn btn-success" href="bikaambon.php" role="button">Resepnya...</a>
              </div>
              </div>
              <div class="card mb-4">
