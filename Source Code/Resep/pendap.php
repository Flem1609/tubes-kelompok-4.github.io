   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">PENDAP IKAN</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI BENGKULU</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/pendap.jpg" alt="Pendap" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>400 gram/4 ekor ikan kembung</h5></li>
              <li><h5>Daun talas untuk bungkus</h5></li>
              <li><h5>1 batang daunsop iris kasar</h5></li>
              <li><h5>2 batang daun bawang</h5></li>
              <li><h5>2 cm lengkuas geprek</h5></li>
              <li><h5>1 batang serai geprek</h5></li>
              <li><h5>3 buah asam kandis</h5></li>
              <li><h5>5 lembar daun mangkokan iris kasar</h5></li>
              <li><h5>100 gram kelapa parut</h5></li>
              <li><h5>300 ml santan</h5></li>
            </ul>
            ...
            <ul type="disc">
              ...
              <li><h5>6 buah cabe merah</h5></li>
              <li><h5>2 cm jahe</h5></li>
              <li><h5>2 cm kunyit dibakar</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Lumuri ikan kembung dengan setengah dari bumbu yang dihaluskan</h5></li>
            <li><h5>Bungkus dengan daun talas menyerupai pepes</h5></li>
            <li><h5>Kukus selama 30 menit</h5></li>
            <li><h5>Remas daun mangkokan dengan garam kemudian cuci hingga bersih dan sisihkan</h5></li>
            <li><h5>Untuk kuahmya, tumis setengah dari bumbu halus</h5></li>
            <li><h5>Tambahkan daun sop, lengkuas, asam kadis, daun mangkokan, daun bawang, dan asam kandis hingga harum</h5></li>
            <li><h5>Tambahkan parutan kelapa, santan, gula, dan garam sesuai selera</h5></li>
            <li><h5>Jika ikan yang dikukus sudah matang, maka tinggal dibuka dan siram dengan kuah yang sudah dimasak</h5></li>
            <li><h5>Pendap ikan siap disantap</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
