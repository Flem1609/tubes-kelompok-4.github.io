   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">NASI KRAWU</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI JAWA TIMUR</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Jawa/nasikrawu.jpg" alt="Nasi Krawu" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>500 gr nasi putih</h5></li>
              <li><h5>Lalapan (timun, kemangi)</h5></li>
              <li><h5>500 gr daging sapi bagian paha</h5></li>
              <li><h5>1 sdt garam</h5></li>
              <li><h5>2 lbr daun salam</h5></li>
              <li><h5>1 batang serai memarkan</h5></li>
              <li><h5>5 siung bawang putih dan bawang merah</h5></li>
              <li><h5>2 sdt ketumbar</h5></li>
              <li><h5>1/4 sdt jintan</h5></li>
              <li><h5>1 cm lengkuas,kunyit</h5></li>
              <li><h5>1 sdt terasi bakar</h5></li>
              <li><h5>Gula merah secukupnya</h5></li>
              <li><h5>1/3 bag kelapa agak muda parut memanjang</h5></li>
              <li><h5>3 lbr daun jeruk</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Campur kelapa dan bumbu halus lalu sangrai dg api kecil hingga kering, sisihkan</h5></li>
            <li><h5>Campur kelapa parut dan bumbu halus lalu sangrai dg api kecil hingga kering, sisihkan</h5></li>
            <li><h5>Rebus daging dg 1 ltr air bersama daun salam, serai dan garam hingga air asat tinggal 250 ml. Potong-potong daging 5 cm lalu disuwar suwir. Masukkan kembali daging suwar suwir kedalam wajan dan tambahkan bumbu halus lalu masak hingga mengering dg api kecil. Nah dalam penyajian daging ini bisa digoreng dulu atau langsung dihidangkan begini juga bisa.</h5></li>
            <li><h5>Goreng cabe merah, cabe kecil, bawang putih dan bawang merah terlebih dahulu dg minyak sedikit. Kemudian haluskan dg ditambahi trasi, asam jawa, gula merah dan garam. Lalu goreng kembali dg sisa minyak yang untuk menggoreng cabe tadi.</h5></li>
            <li><h5>Setelah semua masak, tata rapi dan nasi krawu siap disajikan</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
