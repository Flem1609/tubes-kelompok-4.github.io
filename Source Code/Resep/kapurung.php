...
<head>
    ...
    <title>Kapurung Khas Bugis</title>
   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">KAPURUNG KHAS BUGIS</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sulawesi/kapurung.jpg" alt="Kapurung" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>2-3 orang</h5></li>
              <li><h5>1 buah Jantung pisang</h5></li>
              <li><h5>2 ikat bayam</h5></li>
              <li><h5>1 ikat kacang panjang</h5></li>
              <li><h5>1 buah jagung manis</h5></li>
              <li><h5>Garam</h5></li>
              <li><h5>Kunyit bubuk(untuk merebus ikan)</h5></li>
              <li><h5>Sereh (untuk merebus ikan)</h5></li>
              <li><h5>Penyedap rasa</h5></li>
              <li><h5>Cabe</h5></li>
              <li><h5>Kacang tanah yg sudah di goreng</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Potong semua sayur dan ikan lalu cuci bersih dan tiriskan</h5></li>
            <li><h5>Rebus ikan,masukkan kunyit bubuk,sereh,garam.  </h5></li>
            <li><h5>Diamkan sampai mendidih koreksi rasa lalu matikan api.</h5></li>
            <li><h5>Suir-suir ikan lalu sisihkan</h5></li>
            <li><h5>Rebus jantung pisang yang sudah di iris kecil-kecil,setelah mendidih masukkan bayam,kacang panjang,jagung dan ikan yg sudah di Suir beserta air dari rebusan ikan tadi.</h5></li>
            <li><h5>Cabe dan kacang tanah di ulek/dihaluskan</h5></li>
            <li><h5>Masak dengan menggunakan api sedang agar sayur tidak overcook </h5></li>
            <li><h5>tambahkan cabe dan kacang tanah yang sudah di haluskan,tambahkan garam dan penyedap rasa.</h5></li>
            <li><h5>Aduk-aduk sampai semua bahan benar2 matang </h5></li>
            <li><h5>Koreksi rasa,lalu maatikan api dan siap dihidangkan</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
