   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">AUNU SENEBRE</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI PAPUA UTARA</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Papua/aunusenebre.jpg" alt="Aunu Senebre" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>100 gr teri nasi</h5></li>
              <li><h5>100 gr kelapa parut</h5></li>
              <li><h5>1 batang talas dengan daunnya</h5></li>
              <li><h5>Secukupnya Garam</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan-papeda :</h2>
            <ul type="disc">
              <li><h5>100 gr tepung sagu</h5></li>
              <li><h5>400 ml air</h5></li>
              <li><h5>1 sdt kaldu bubuk</h5></li>
              <li><h5>1 siung bawang putih</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan-pendamping :</h2>
            <ul type="disc">
              <li><h5>Secukupnya Talas kukus</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
              <li><h5>Siapkan bahan bahannya</h5></li>
              <li><h5>Cuci bersih batang dan daun talas, lalu kukus sampai matang, angkat lalu iris iris sisihkan</h5></li>
              <li><h5>Cuci bersih teri nasi, lalu tiriskan,kemudian goreng sebentar, tidak terlalu kering. Angkat dan tiriskan.</h5></li>
              <li><h5>Dalam wadah, masukkan kelapa parut, teri yang sudah di goreng, dan batang talas yg sudah di iris, campur rata lalu kukus selama 25 menit (sampai matang)</h5></li>
              <li><h5>Siapkan bahan untuk membuat papeda,dalam wadah masukkan tepung sagu dengan 200ml air campur rata, beri kaldu dan bawang putih uleg</h5></li>
              <li><h5>Rebus air sampai mendidih, masukkan adonan tepung sagu, sambil diaduk, masak sampai meletup2</h5></li>
              <li><h5>Siapkan bahan pendamping lain, Kupas talas dan cuci bersih. (Disini bisa pake umbi apapun, bisa singkong, ubi, kentang ataupun talas), kukus sampai matang</h5></li>
              <li><h5>Cara penyajian, aunu senebre disajiakn dengan umbi umbian dan biasa juga disajiakn dengan papeda</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
