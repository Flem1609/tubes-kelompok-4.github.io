...
<head>
    ...
    <title>Daging Masak Hitam</title>
   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">DAGING MASAK HITAM</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/dagingmasakhitam.jpg" alt="Daging Masak Hitam" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>500 gram daging sapi has dalam, dipotong-potong</h5></li>
              <li><h5>100 gram kelapa, sangrai</h5></li>
              <li><h5>1/4 sendok teh jintan</h5></li>
              <li><h5>1/4 sendok teh adas manis</h5></li>
              <li><h5>1 sendok teh ketumbar</h5></li>
              <li><h5>2 cm kayu manis</h5></li>
              <li><h5>1/4 sendok teh pala bubuk</h5></li>
              <li><h5> 1/4 sendok teh lada putih bubuk</h5></li>
              <li><h5>1/2 sendok teh garam</h5></li>
              <li><h5>5 sendok makan Kecap Manis Bango</h5></li>
              <li><h5>500 ml santan (dari 3/4 butir kelapa)</h5></li>
            </ul>
            <h2 style="font-family: 'Lobster', cursive; margin-bottom: 20px; margin-left:-35px">Bumbu Halus (digoreng dahulu) : </h2>
            <ul>
              <li><h5>8 butir bawang merah</h5></li>
              <li><h5>3 siung bawang putih</h5></li>
              <li><h5>4 butir kemiri, sangrai</h5></li>
              <li><h5>2 cm jahe</h5></li>
              <li><h5>1 batang serai, diambil putihnya</h5></li>
              <li><h5>2 cm lengkuas</h5></li>              
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Campur bumbu halus bersama kelapa sangrai, jintan, adas manis, ketumbar, kayu manis, pala bubuk, lada putih bubuk, dan garam sampai rata.</h5></li>
            <li><h5>Aduk campuran bumbu dan daging. Diamkan 20 menit.</h5></li>
            <li><h5>Masak daging berlumur bumbu di dalam panci. Tambahkan Kecap Manis Bango. Aduk sampai daging terbalut Kecap Manis Bango.</h5></li>
            <li><h5>Tuangkan santan sedikit demi sedikit. Masak sampai daging matang dan kuah mengental.</h5></li>             
            </ul>         
          </div>
        </div>    
    </section>
