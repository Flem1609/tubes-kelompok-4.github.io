   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">SAMBAL KRECEK</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI YOGYAKARTA</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Jawa/sambalkrecek.jpg" alt="Sambal Krecek" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>3 sendok makan minyak goreng</h5></li>
              <li><h5>2 buah tomat (diblender)</h5></li>
              <li><h5>gula merah secukupnya</h5></li>
              <li><h5>250 gr kerupuk kulit</h5></li>
              <li><h5>100 ml santan</h5></li>
              <li><h5>100 ml air</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Panaskan minyak. Tumis tomat, gula merah , Masak hingga harum.</h5></li>
            <li><h5>Masukkan kerupuk kulit . Aduk dan masak hingga lembut.</h5></li>
            <li><h5>Tuang campuran santan dan air. Aduk rata dan masak hingga matang.</h5></li>
            <li><h5>Siap disajikan dengan nasi hangat.</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
