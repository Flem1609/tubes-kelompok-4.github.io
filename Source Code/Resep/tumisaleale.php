   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">TUMIS ALE-ALE</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Kalimantan/tumisaleale.jpg" alt="Tumis Ale-Ale" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>Sediakan 1 mangkok kecil Ale-ale.</h5></li>
              <li><h5>Siapkan 1 sdt gula.</h5></li>
              <li><h5>Sediakan 1 sdt garam.</h5></li>
              <li><h5>Sediakan secukupnya Totole.</h5></li>
              <li><h5>Sediakan 5 siung bawang putih.</h5></li>
              <li><h5>Siapkan 7 siung bawang merah.</h5></li>
              <li><h5>Sediakan 1 buah cabe merah.</h5></li>
              <li><h5>Siapkan 10 cabe rawit.</h5></li>
              <li><h5>Sediakan secukupnya Minyak goreng.</h5></li>
              <li><h5>Siapkan 1 sdm saos tiram.</h5></li>         
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Siapkan semua bahan-bahan.</h5></li>
            <li><h5>Iris kasar bawang putih, bawang merah, dan cabe.</h5></li>
            <li><h5>Panaskan minyak goreng, setelah panas masukkan irisan bumbu tadi.</h5></li>
            <li><h5>Setelah harus masukkan ale-ale.</h5></li>
            <li><h5>Kemudian tambahkan saos tiram, gula, garam dan totole.</h5></li>
            <li><h5>Tumis sampai mateng, icip icip dehh.</h5></li>   
            </ul>         
          </div>
        </div>    
    </section>
