...
<head>
    ...
    <title>Sup Tuna Kuah Asam </title>
   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">Sup Tuna Kuah Asam</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Bali dan Sekitarnya/suptunakuahasam.jpg" alt="Sup Tuna Kuah Asam" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
            <li><h5>500 gr ikan tuna segar, potong kotak</h5></li>
              <li><h5>8 buah belimbing wuluh, potong 4</h5></li>
              <li><h5>10 buah cabai rawit, iris</h5></li>
              <li><h5>10 buah cabai rawit utuh</h5></li>
              <li><h5>1 batang daun bawang, iris</h5></li>
              <li><h5>2 buah jeruk nipis, peras</h5></li>
              <li><h5>6 siung bawang putih</h5></li>
              <li><h5>4 siung bawang merah</h5></li>
              <li><h5>1 ruas ibu jari kunyit</h5></li>           
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Cuci bersih ikan lalu beri perasan jeruk nipis. Diamkan kurang lebih 20 menit</h5></li>
            <li><h5>Didihkan 1 liter air lalu masukan bumbu halus dan cabai rawit iris. Aduk hingga merata</h5></li>
            <li><h5>Masukan ikan dan belimbing wuluh. Aduk hingga semua merata</h5></li>
            <li><h5>Kemudian masukan cabai rawit utuh dan daun bawang. Aduk hingga merata dan masak hingga ikan matang</h5></li>
            <li><h5>Sajikan.</h5></li>
            </ul>         
          </div>
        </div>    
