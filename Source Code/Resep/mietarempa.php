   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">MIE TAREMPA</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/mietarempa.png" alt="Mie Tarempa" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1 bungkus mie gepeng</h5></li>
              <li><h5>8 buah cabai merah</h5></li>
              <li><h5>2 siung bawang merah</h5></li>
              <li><h5>4 siung bawang putih</h5></li>
              <li><h5>100 gr daging ikan tongkol</h5></li>
              <li><h5>50 gr tauge atau sesuai selera</h5></li>
              <li><h5>2 sdm kecap manis</h5></li>
              <li><h5>1 sdm kecap asin</h5></li>
              <li><h5>1 sdm saus tiram</h5></li>
              <li><h5>1 sdm saus tomat</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
            <li><h5>Rebus mie hingga lembut, tiriskan lalu sisihkan</h5></li>
            <li><h5>Lumuri ikan dengan jeruk nipis dan garam secukupnya, kukus hingga matang lalu suwir. Sisihkan</h5></li>
            <li><h5>Haluskan bawang merah dan bawang putih, haluskan juga cabai namun secara terpisah dengan bawang</h5></li>
            <li><h5>Tumis bawang halus, setelah wangi masukkan cabai halus dan aduk hingga rata</h5></li>
            <li><h5>Masukkan sedikit air</h5></li>
            <li><h5>Masukkan ikan tongkol, aduk hingga terbalur rata dengan bumbu</h5></li>
            <li><h5>Masukkan kecap manis, kecap asin, saus tiram, saus tomat, dan kaldu jamur sesuai selera. Aduk hingga rata</h5></li>
            <li><h5>Masukkan mie dan tauge</h5></li>
            <li><h5>Aduk hingga semua bumbu merata, matikan api dan sajikan</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
