   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">NASI SUBUT</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI KALIMANTAN UTARA</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Kalimantan/nasisubut.jpg" alt="Nasi Subut" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>500 gram beras</h5></li>
              <li><h5>200 gram ubi ungu</h5></li>
              <li><h5>200 gram jagung manis pipilan</h5></li>
              <li><h5>500 ml liter air</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Didihkan air, masukkan beras dan masak beras hingga menjadi beras aron.</h5></li>
            <li><h5>Lalu tambahkan ubi dan jagung ke dalam beras aron yang masih dimasak</h5></li>
            <li><h5>Kukus dalam kukusan panas hingga nasi matang</h5></li>
            <li><h5>Nasi subut siap disajikan</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
