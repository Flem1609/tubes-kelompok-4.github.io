   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">GOHU IKAN TUNA</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Maluku/gohuikantuna.jpg" alt="Gohu Ikan Tuna" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">A
              <li><h5>400 gr ikan tuna segar filet</h5></li>
              <li><h5>3 buah jeruk ikan</h5></li>
              <li><h5>5 siung bawang merah (saya pake yg ukuran besar)diiris</h5></li>
              <li><h5>10 buah cabe rawit (opsional)</h5></li>
              <li><h5>4 sdm kacang tanah yg udh d goreng dan dihaluskan kasar</h5></li>
              <li><h5>Daun kemangi secukupnya (diambil daunnya)</h5></li>
              <li><h5>Penyedap rasa (saya pake royk*)</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
              <li><h5>Potong dadu kecil ikan tuna yg sudah d filet, cuci menggunakan air matang / air minum beberapa kali, tiriskan, pindahkann ke tempat/mangkuk yg tahan panas </h5></li>
              <li><h5>Masukan perasan jeruk kedalam ikan dan penyedap rasa, aduk2 sebentar lalu sisihkan</h5></li>
              <li><h5>Masukan irisan bawang merah, cabe rawit, kacang goreng, aduk2 sampai rata, koreksi rasa</h5></li>
              <li><h5>Panaskan minyak goreng sampai benar2 panas, lalu siram ke campuran ikan yg sudah d bumbui tadi, lalu di aduk perlahan</h5></li>
              <li><h5>Masukan daun kemangi, aduk sebentar, siap disajikan</h5></li></ul>         
          </div>
        </div>    
    </section>
    <br>
