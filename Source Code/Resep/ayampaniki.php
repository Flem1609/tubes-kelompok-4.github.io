   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">AYAM PANIKI</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Maluku/ayampaniki.jpg" alt="Ayam Paniki" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1 kg ayam </h5></li>
              <li><h5>1 bungkus santan kara ukuran kecil</h5></li>
              <li><h5>1 sdm air jeruk nipis / 2 biji asam</h5></li>
              <li><h5>Secukupnya gula pasir</h5></li>
              <li><h5>Secukupnya garam</h5></li>
              <li><h5>Secukupnya kaldu bubuk</h5></li>
              <li><h5>1 ruas lengkuas</h5></li>
              <li><h5>2 lembar daun jeruk purut</h5></li>
            ...
            <ul type="disc">
              <li><h5>5 butir kemiri sangrai</h5></li>
              <li><h5>7 siung bawang merah</h5></li>
              <li><h5>5 siung bawang putih</h5></li>
              <li><h5>5 buah cabai merah</h5></li>
              <li><h5>5 buah cabai rawit</h5></li>
              <li><h5>1/2 sdt terasi bakar</h5></li>
              <li><h5>2 cm jahe</h5></li>
              <li><h5>2 cm kunyit</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
              <li><h5>Siapkan bahan2, blender bumbu halus</h5></li>
              <li><h5>Tumis bumbu halus, masukkan lengkuas yang sudah dipotong2, daun salam, daun jeruk purut, serai. Lalu masukkan potongan ayam</h5></li>
              <li><h5>Lalu tambahkan air, dan beri air jeruk nipis. Tunggu hingga air menyusut lalu sisihkan</h5></li>
              <li><h5>Siapkan panggangan, olesi blueband lalu panggang ayam nya hingga matang</h5></li>
              <li><h5>Selesai. Hidangkan 👏</h5></li></ul>         
          </div>
        </div>    
    </section>
    <br>
