   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">LUMPIA</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;">RESEP MAKANAN DAERAH KHAS YANG BERASAL DARI PROVINSI JAWA TENGAH</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Jawa/lumpia.jpg" alt="Lumpia" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>10 lembar kulit lumpia instan</h5></li>
              <li><h5>2 sdm tepung terigu dan 1 sdm air dilarutkan untuk perekat</h5></li>
              <li><h5>minyak goreng</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan-isian :</h2>
            <ul type="disc">
              <li><h5>¼ sendok teh merica bubuk</h5></li>
              <li><h5>¼ sendok teh gula pasir</h5></li>
              <li><h5>3 siung bawang putih, cincang halus</h5></li>
              <li><h5>2 sendok teh ebi sangrai, dihaluskan</h5></li>
              <li><h5>200 gram rebung kaleng, diiris tipis</h5></li>
              <li><h5>½ sendok makan saus tiram</h5></li>
              <li><h5>150 gram udang kupas, cincang kasar</h5></li>
              <li><h5>2 butir telur, dikocok lepas</h5></li>
              <li><h5>1 sendok makan kecap manis,</h5></li>
              <li><h5>2 sendok makan minyak untuk menumis,</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
            <li><h5>Panaskan minyak terlebih kemudian tumis bawang putih dan ebi sampai harum</h5></li>
            <li><h5>Masukkan udang yang sudah dicincang lalu aduk sampai berubah warna</h5></li>
            <li><h5>Sisihkan, lalu masukkan telur kemudian aduk sampai matang dan tambahkan rebung</h5></li>
            <li><h5>Aduk semuanya hingga layu</h5></li>
            <li><h5>Selanjutnya, masukkan saus tiram, kecap manis, garam, merica bubuk, dan gula pasir dan aduk hingga merata dan meresapSelanjutnya, masukkan saus tiram, kecap manis, garam, merica bubuk, dan gula pasir dan aduk hingga merata dan meresap</h5></li>
            <li><h5>Ambil selembar kulit lumpia dan tata isian yang sudah ditumis</h5></li>
            <li><h5>Lipat dan gulung lumpia, rekatkan dengan larutan tepung terigu</h5></li>
            <li><h5>Goreng dalam minyak yang sudah dipanaskan sampai matang hingga coklat keemasan dan tiriskan</h5></li>
            <li><h5>Lumpia siap disajikan</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
