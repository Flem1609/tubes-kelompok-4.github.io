   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">TEMPOYAK (SAMBAL DURIAN)</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI BENGKULU</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/tempoyak.jpg" alt="Tempoyak" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>300 gram daging durian yang sudah difermentasi</h5></li>
              <li><h5>25 gram ikan teri tawar</h5></li>
              <li><h5>5 lembar daun jeruk robek</h5></li>
              <li><h5>3 lembar daun kunyit</h5></li>
              <li><h5>4 cm lengkuas geprek</h5></li>
            ...
            <ul type="disc">
              <li><h5>150 gram cabai sesuai selera, bisa cabai kriting atau rawit</h5></li>
              <li><h5>4 butir bawang putih</h5></li>
              <li><h5>10 butir bawang merah</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Siapkan fermentasi durian, caranya masukkan durian kedalam toples selama 2- 3 hari. Kemudian pisahkan daging dan bijinya</h5></li>
            <li><h5>Cuci ikan teri tawar kemudian sangrai hingga kering</h5></li>
            <li><h5>Siapkan penggorengan</h5></li>
            <li><h5>Masukkan bumbu halus, lengkuas, daun kunyit, daun jeruk, daging durian, dan air</h5></li>
            <li><h5>Masak dengan api sedang sambil diaduk</h5></li>
            <li><h5>Jika air sudah mulai berkurang, maka tambahkan teri dan garam secukupnya</h5></li>
            <li><h5>Tempoyak siap disajikan</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
