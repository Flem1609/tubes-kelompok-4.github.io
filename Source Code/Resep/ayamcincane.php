   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">AYAM CINCANE</h1>
          <br>
          <h2 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI KALIMANTAN TIMUR</h2>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Kalimantan/ayamcincane.jpeg" alt="Ayam Cincane" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1 kg ayam kampung</h5></li>
              <li><h5>3 lembar daun salam</h5></li>
              <li><h5>1 batang serai, memarkan</h5></li>
              <li><h5>200 ml santan kental</h5></li>
              <li><h5>500 ml santan encer</h5></li>
              <li><h5>1 biji gula merah</h5></li>
              <li><h5>Garam secukupnya</h5></li>
              <li><h5>Air asam jawa</h5></li>        
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan Halus :</h2>
            <ul type="disc">
              <li><h5>5 siung bawang putih</h5></li>
              <li><h5>8 siung bawang merah</h5></li>
              <li><h5>3 buah cabai merah</h5></li>
              <li><h5>20 buah cabai keriting merah</h5></li>
              <li><h5>3 biji kemiri</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
              <li><h5>Cuci ayam hingga bersih dengan air mengalir, selanjutnya rendam dengan menggunakan air asam jawa.</h5></li>
              <li><h5>Tumis bumbu halus dengan daun serai dan daun salam hingga harum. Lalu masukkan ayam kampung, dan aduk hingga merata.</h5></li>
              <li><h5>Setelah itu masukkan santan kental aduk-aduk, dan biarkan sebentar.</h5></li>
              <li><h5>Setelah mendidih, tuangkan santan encer dan bumbu-bumbu lainnya, masak dengan menggunakan api kecil.</h5></li>
              <li><h5>Masaklah hingga bumbu mulai meresap dan kental. Lalu diamkan ayam sampai beberapa jam, biarkan bumbu meresap ke dalam daging ayam.</h5></li>
              <li><h5>Lalu, panggang ayam menggunakan arang, bolak-balik biar tidak gosong.</h5></li>
              <li><h5>Dirasa sudah matang, sajikan ayam cincane dengan nasi hangat.</h5></li>            
            </ul>         
          </div>
        </div>    
    </section>
