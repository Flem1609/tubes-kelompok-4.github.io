   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">MIE ACEH</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI NANGGROE ACEH DARUSSALAM</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/mieaceh.jpg" alt="Mie Aceh" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>500 gr mie kuning</h5></li>
              <li><h5>150 gr udang</h5></li>
              <li><h5>100 gr daging sapi, potong kotak-kotak kecil</h5></li>
              <li><h5>100 gr kol putih, iris</h5></li>
              <li><h5>100 gr toge</h5></li>
              <li><h5>1 buah tomat, potong memanjang</h5></li>
              <li><h5>1 sdm kecap asin</h5></li>
              <li><h5>2 batang daun bawang, iris halus</h5></li>
              <li><h5>2 sdm kecap manis</h5></li>
              <li><h5>4 siung bawang putih, iris</h5></li>
              <li><h5>4 siung bawang merah, iris</h5></li>
              <li><h5>Garam secukupnya</h5></li>
              <li><h5>Kaldu jamur secukupnya</h5></li>
              <li><h5>2 sdm minyak untuk menumis</h5></li>
              <li><h5>Emping secukupnya</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu-halus :</h2>
            <ul type="disc">
              <li><h5>1 sdt garam</h5></li>
              <li><h5>1/2 sdt merica</h5></li>
              <li><h5>1/4 sdt adas manis</h5></li>
              <li><h5>2 buah kapulaga</h5></li>
              <li><h5>2 buah kemiri</h5></li>
              <li><h5>2 sdm bubuk kari india</h5></li>
              <li><h5>3 siung bawang putih</h5></li>
              <li><h5>5 buah cabai rawit</h5></li>
              <li><h5>1 sdm minyak untuk menghaluskan bumbu</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Haluskan semua bumbu lalu tambahkan sedikit minyak. Sisihkan.</h5></li>
            <li><h5>Tumis bawang merah dan bawang putih, masukkan udang dan daging. Aduk hingga berubah warna.</h5></li>
            <li><h5>Masukkan bumbu halus dan mie kuning, aduk rata.</h5></li>
            <li><h5>Tambahkan tauge, kecap manis, garam dan kaldu jamur. Koreksi rasa. Angkat.</h5></li>
            <li><h5>Emping dengan toping di atasnya</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
