   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">TINUTUAN</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN DAERAH KHAS YANG BERASAL DARI PROVINSI SULAWESI TENGAH</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sulawesi/tinutuan.jpg" alt="Tinutuan" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>300 g beras, cuci bersih</h5></li>
              <li><h5>3 L air</h5></li>
              <li><h5>1 sdt garam</h5></li>
              <li><h5>2 sdt Royco Kaldu Ayam</h5></li>
              <li><h5>100 g labu kuning, kupas, potong dadu</h5></li>
              <li><h5>75 g ubi jalar, kupas, potong dadu</h5></li>
              <li><h5>75 g jagung muda, bersihkan, pipil</h5></li>
              <li><h5>75 g bayam, petiki, cuci bersih</h5></li>
              <li><h5>75 g kangkung, petiki, cuci bersih</h5></li>
              <li><h5>4 batang daun kemangi, petiki, cuci bersih</h5></li>
              <li><h5>2 batang serai, memarkan</h5></li>
              <li><h5>1 batang daun bawang, iris halus</h5></li>
              <li><h5>2 lembar daun kunyit</h5></li>
              <li><h5>150 g ikan asin jambal, potong dadu, goreng hingga matang dan kecokelatan</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Dalam panci, masak beras bersama air, garam, daun bawang, serai, daun kunyit, dan Royco Kaldu Ayam. Aduk terus di atas api sedang hingga beras setengah matang.</h5></li>
            <li><h5>Masukkan ubi jalar, labu kuning, dan jagung. Aduk rata, masak hingga ubi lembut.</h5></li>
            <li><h5>Masukkan bayam, kangkung, daun melinjo, dan daun kemangi. Aduk rata. Masak hingga matang dan bubur mengental.</h5></li>
            <li><h5>Angkat dan sajikan bersama ikan asin. Selain untuk masa pemulihan, jadikan tinutuan juga sebagai panganan sehari-harimu di rumah. Coba padukan juga dengan sambal kesukaanmu. Rasanya semakin meriah!.</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
