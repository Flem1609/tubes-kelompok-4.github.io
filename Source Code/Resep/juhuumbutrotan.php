   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">JUHU UMBUT ROTAN</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI KALIMANTAN TENGAH</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Kalimantan/juhuumbutrotan.jpg" alt="Juhu Umbut" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1 ikat umbut latung rotan</h5></li>
              <li><h5>½ biji terong asam (rembang)</h5></li>
              <li><h5>1 ikat kacang panjang</h5></li>
              <li><h5>Ikan patin</h5></li>
            </ul>
            ...
            <ul type="disc">
              ...
              <li><h5>3 cm lengkuas</h5></li>
              <li><h5>Seruas kelingking jahe</h5></li>
              <li><h5>4 biji kemiri</h5></li>
              <li><h5>3 cm kunyit</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
            <li><h5>Siapkan semua bahan</h5></li>
            <li><h5>Haluskan bumbu, marinasi ikan dan bumbu halus, sisihkan</h5></li>
            <li><h5>Kupas separuh terong asam dan iris, potong kacang panjang, cuci bersih, umbut rotan potong dan rendam di air biasa.</h5></li>
            <li><h5>Rebus air hingga mendidih, masukan terong asam (rembang), dan umbut rotan yang sudah dicuci bersih, tutup panci agar cepat empuk</h5></li>
            <li><h5>Masukan kacang panjang, ikan patin + bumbu, tambahkan garam dan vetsin, biarkan kuah mendidih sebentar, jika ikan sudah matang, koreksi rasa dan matikan api</h5></li>
            <li><h5>Tempatkan juhus ingkah umbut rotan dimangkok</h5></li>
            <li><h5>Sangat nikmat disajikan bersama pelengkapnya nasi hangat,sambal dan lauknya ikan goreng atau ikan bakar.</h5></li>           
            </ul>         
          </div>
        </div>    
    </section>
