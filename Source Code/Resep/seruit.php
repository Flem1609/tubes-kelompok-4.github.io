   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">SERUIT</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI LAMPUNG</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/seruit.jpg" alt="Seruit" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan Ikan :</h2>
            <ul type="disc">
              <li><h5>2 ekor ikan patin (ikan jenis lain juga bisa)</h5></li>
            ...
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan Sambal :</h2>
            <ul type="disc">
              <li><h5>2 sdm mangga muda</h5></li>
              <li><h5>2 sdm tempoyak</h5></li>
              <li><h5>3 buah cabai keriting</h5></li>
              <li><h5>5 buah cabai rawit</h5></li>
              <li><h5>1 buah tomat</h5></li>               
              <li><h5>3 siung bawang merah</h5></li>
              <li><h5>2 siung bawang putih</h5></li>
              <li><h5>1 cm terasi</h5></li>
              <li><h5>1 sdm perasan jeruk nipis</h5></li>
          ...
          <div class="col mt-2">
            ...
            <ul type="circle">
              <li><h5>Cuci bersih ikan, lumuri dengan garam dan jeruk nipis. Biarkan selama 10 menit. Bilas bersih.</h5></li>
              <li><h5>Haluskan bawang putih, kunyit dan garam. Lumuri ikan dengan bumbu, diamkan selama 15 menit.</h5></li>
              <li><h5>Goreng ikan hingga matang dan renyah, angkat dan tiriskan.</h5></li>
              <li><h5>Haluskan bahan sambal kecuali perasan jeruk nipis dan mangga muda, cukup cincang kecil. Tumis hingga matang, tes rasa, jika sudah pas, angkat. Beri perasan jeruk nipis.</h5></li>
              <li><h5>Sajikan ikan goreng dengan sambal Seruit siap dinikmati dengan nasi hangat.</h5></li>            
            </ul>         
          </div>
        </div>    
    </section>
