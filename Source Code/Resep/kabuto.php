   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">KABUTO</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI SULAWESI TENGGARA</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sulawesi/kabuto.jpg" alt="Kabuto" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>500 gr kakombo (singkong yg sdh dikeringkan, khas Muna) </h5></li>
              <li><h5>Kelapa muda parut</h5></li>
              <li><h5>Secukupnya Garam</h5></li>
              <li><h5>Gula pasir/ Gula merah (Bila suka manis)</h5></li>
              <li><h5>Ikan asin (goreng)</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Kakombo di potong kecil2 lalu direndam air selama 8 jam (Agar singkong lembek dan kenyal)</h5></li>
            <li><h5>Tiriskan kakombo yang sudah direndam</h5></li>
            <li><h5>Siapkan panci kukusan lalu Kakombo dikukus selama 15-20 menit (Bila suka manis, kakombo bisa dikukus bersama gula merah)</h5></li>
            <li><h5>Jika sudah matang tambahkan sedikit garam lalu dikeluarkan dari panci</h5></li>
            <li><h5>Kabuto (kakombo yg telah matang) disajikan dipiring bersama parutan kelapa muda dan ikan asin goreng. 😀makanan siap dihidangkan 😀</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
