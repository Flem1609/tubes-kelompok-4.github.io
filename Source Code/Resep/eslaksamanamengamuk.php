...
<head>
    ...
    <title>Es Laksamana Mengamuk</title>
   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">ES LAKSAMANA MENGAMUK</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/eslaksamanamengamuk.jpg" alt="Es Laksamana Mengamuk" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>90 gr mangga harum manis, ambil setengah buah mangga</h5></li>
              <li><h5>1 sdt biji selasih</h5></li>
              <li><h5>1 lembar daun pandan</h5></li>
              <li><h5>50 gr krimer bubuk</h5></li>
              <li><h5>300 ml air</h5></li>
              <li><h5>5 sdm gula pasir</h5></li>
              <li><h5>Garam</h5></li>
              <li><h5>Vanili bubuk</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Campurkan krimer dengan air, aduk merata sampai tercampur</h5></li>
            <li><h5>Masak larutan krimer, daun pandan, gula pasir, sejumput garam, dan vanili</h5></li>
            <li><h5>Aduk hingga mendidih, angkat dan sisihkan</h5></li>
            <li><h5>Rendam biji selasih dengan air hangat. Saring</h5></li>
            <li><h5>Kemudian cuci menggunakan saringan dengan air mengalir</h5></li>
            <li><h5>Setelah itu taruh di dalam mangkok</h5></li>
            <li><h5>Potong dadu mangga, sisihkan</h5></li>
            <li><h5>Setelah bahan siap, racik di gelas saji</h5></li>
            <li><h5>Siapkan 1 gelas, isi dengan es batu, potongan mangga, selasih, dan larutan krimer</h5></li>
            <li><h5>Aduk-aduk hingga tercampur semua. Es laksamana mengamuk siap dinikmati</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
