   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">KUE BINGKA</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Kalimantan/kuebingka.jpeg" alt="Kue Bingka" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan A :</h2>
            <ul type="disc">
              <li><h5>3 butir telur ayam</h5></li>
              <li><h5>200 gr gula pasir</h5></li> 
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan B :</h2>
            <ul type="disc">
              <li><h5>500 gr kentang kukus, haluskan</h5></li>
              <li><h5>500 gr tepung terigu</h5></li>
              <li><h5>1 sdt vanili</h5></li>
              <li><h5>1 sdt garam</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bahan C :</h2>
            <ul type="disc">
              <li><h5>600 cc santan kental</h5></li>
              <li><h5>1/2 kaleng susu kental manis</h5></li>
              <li><h5>100 gr mentega cair</h5></li>  
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Kocok bahan A sampai gula larut, kemudian masukkan bahan B dan C silih berganti sampai habis dan aduk sampai rata.</h5></li>
            <li><h5>Setelah rata masukkan kedalam loyang dan panggang sampai warnanya agak cokelat dan matang.</h5></li>
            <li><h5>Setelah matang, biarkan dingin dulu baru dikeluarkan dari loyang.</h5></li>
            <li><h5>Selamat menikmati.</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
