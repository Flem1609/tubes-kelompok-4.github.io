   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">KUE LONTAR PAPUA</h1>
          <br>
          <h4 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI PAPUA</h4>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Papua/kuelontar.jpg" alt="Kue Lontar" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>280 gr tepung terigu</h5></li>
              <li><h5>150 gr margarin</h5></li>
              <li><h5>9 butir telur ayam</h5></li>
              <li><h5>1/2 sdt Vanili essense</h5></li>
              <li><h5>1 kaleng SKM</h5></li>
              <li><h5>1 kaleng air hangat</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
              <li><h5>Buat kulitnya dulu:</h5></li>
              <li><h5>Campur tepung, margarine dan 1 kuning telur.</h5></li>
              <li><h5>Ratakan di piring lontar/pyrex atau alumunium foil ukuran 22cm, tusuk2 dengan garpu tengahnya, ambil sedikit adonan gulung lalu lingkari dipinggiran piring, lalu cubit dengan cetakan nastar, garpu, bebas buat kreasi agar cantik terlihat.</h5></li>
              <li><h5>Buat isian, campur 5 kuning telur, dan 3 telur utuh masukan vanili essense 1/2sdt, masukan SKM dan air hangat, aduk2 pelan jangan sampai berbusa.</h5></li>
              <li><h5>Saring kedalam kulit lontar yang sudah dibentuk di dalam cetakan.</h5></li>
              <li><h5>Oven tangkring sudah panas terlebih dahulu yah, masukan di rak tengah, panggang selama 2,5-3,5 jam tergantung dengan kondisi api kompor/oven masing2 yah…</h5></li>
              <li><h5>Jika suda menguning emas, matikan kompor, diamkan 10-15 menit dlu baru dikeluarkan yah, selamat menikmati 🥰</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
