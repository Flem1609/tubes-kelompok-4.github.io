   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">NASI TIMBEL</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Jawa/nasitimbel.jpg" alt="Nasi Timbel" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>1 1/2 cup Beras</h5></li>
              <li><h5>3 cup Air</h5></li>
              <li><h5>1 Batang sereh, memarkan, ikat simpul</h5></li>
              <li><h5>2 Lembar daun pandan, sobek, ikat simpul</h5></li>
              <li><h5>2 Lembar daun jeruk </h5></li>
              <li><h5>1 Genggam kemangi (optional, bila suka) </h5></li>
              <li><h5>Secukupnya daun pisang </h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Siapkan panci kecil, masukkan beras, sereh, pandan, daun jeruk dan air.</h5></li>
            <li><h5>Masak kurang lebih 10-15 menit sampai air mengering. Angkat.</h5></li>
            <li><h5>Ambil daun pisang, letakkan nasi, kemangi (jika suka)</h5></li>
            <li><h5>Bungkus dengan rapi, lalu kukus selama 30 menit. Angkat</h5></li>
            <li><h5>Nasi timbel siap disajikan (bisa ditambahkan dengan lauk lainnya)</h5></li>
            </ul>         
          </div>
        </div>    
    </section>
