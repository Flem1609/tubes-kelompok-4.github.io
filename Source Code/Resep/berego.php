   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">BEREGO</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;">RESEP MAKANAN KHAS YANG BERASAL DARI PROVINSI BANGKA BELITUNG</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/berego.jpg" alt="Berego" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
        ...
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              ...
              <li><h5>250 gr tepung sagu</h5></li>
              <li><h5>1 sdt garam dan 750 ml air</h5></li>     
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
              <li><h5>Campur tepung beras, tepung sagu, dan garam menjadi satu.</h5></li>
              <li><h5>Tuangkan air sedikit demi sedikit sambil diaduk hingga menjadi adonan yang kalis dan tidak berbutir.</h5></li>
              <li><h5>Panaskan ke dalam kukusan loyang ukuran 20 x 20 cm yang telah diolesi dengan sedikit minyak.</h5></li>
              <li><h5>Tuangkan 1 sendok sayur adonan, ratakan. Kukus hingga matang.</h5></li>
              <li><h5>Tuangkan kembali di atasnya, lakukan hal yang sama hingga adonan habis dan biarkan hingga benar-benar matang.</h5></li>
              <li><h5>Angkat, keluarkan dari loyang. Selagi masih panas, gulung, dan potong-potong selebar 1 1/2 cm. Sajikan Barego khas Belitung bersama kuah kari ikan.</h5></li>             
            </ul>
          </div>
        </div>    
    </section>
