   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">BIKA AMBON</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/bikaambon.jpg" alt="Bika Ambon" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>100 gr terigu protein sedang</h5></li>
              <li><h5>200 ml air kelapa</h5></li>
              <li><h5>11 gram ragi instan</h5></li>
              <li><h5>16 butir kuning telur</h5></li>
              <li><h5>400 gram gula pasir</h5></li>
              <li><h5>300 gram sagu</h5></li>
              <li><h5>600 ml santan kental</h5></li>
              <li><h5>1 lembar daun pandan (simpul)</h5></li>
              <li><h5>3 lembar daun jeruk</h5></li>
              <li><h5>1 sdt garam</h5></li>
              <li><h5>1 sdt vanili</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
            <li><h5>Rebus santan kental bersama daun pandan dan daun jeruk hingga matang dan agak berminyak. Biarkan mendingin.Aduk terigu, air kelapa, dan ragi hingga rata, lalu diamkan 15 menit</h5></li>
            <li><h5>Aduk rata terigu, ragi, dan air kelapa. Diamkan 15 menit</h5></li>
            <li><h5>Campurkan telur, garam, dan vanili, aduk rata. Masukkan larutan ragi, tepung sagu, dan tuang santan sedikit demi sedikit sambil diaduk hingga merata</h5></li>
            <li><h5>Diamkan adonan selama 2 jam, tutup dengan kain bersih</h5></li>
            <li><h5>Lapisi loyang dengan margarin atau minyak tipis-tipis, tuang adonan</h5></li>
            <li><h5>Panggang adonan di suhu 180°C selama 40 menit. Berikan sedikit celah di pintu oven selama 20-30 menit pertama agar sarang terbentuk, lalu tutup pintu oven setelahnya</h5></li>
            <li><h5>Sajikan</h5></li>
            </ul>         
          </div>
        </div>    
