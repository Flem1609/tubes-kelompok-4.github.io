   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">NASI LAPOLA</h1>
          <br>
      ...
      <div class="image">
          ...
          <img src="Gambar/Maluku/nasilapola.jpg" alt="Nasi Lapola" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>500 g beras</h5></li>
              <li><h5>200 g kacang tolo</h5></li>
              <li><h5>1/2 buah kelapa setengah tua parut</h5></li>
              <li><h5>500 ml air untuk merebus kacang tolo</h5></li>
            </ul>
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Bumbu-daun :</h2>
            <ul type="disc">
              <li><h5>2 btng sereh geprek</h5></li>
              <li><h5>2 ruas lengkuas geprek iris</h5></li>
              <li><h5>3 ruas jahe geprek</h5></li>
              <li><h5>3 lembar daun salam</h5></li>
              <li><h5>1000 ml air kelapa</h5></li>
              <li><h5>4 lembar daun jeruk</h5></li>
              <li><h5>6 butir cengkeh</h5></li>
              <li><h5>1 cm kayu manis</h5></li>
              <li><h5>3/4 buah pala</h5></li>
              <li><h5>1 lembar daun pandan</h5></li>
              <li><h5>1 sdt garam</h5></li>
              <li><h5>1 bngks kaldu bubuk rasa sapi opsional</h5></li>
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
              <li><h5>Cuci bersih beras,kacang tolo kemudian rebus kacang tolo sampai matang angkat tiriskan</h5></li>
              <li><h5>Rebus air kelapa bersama bumbu daun setelah mendidih masukkan santan beras kacang tolo</h5></li>
              <li><h5>Masak sampai air menyusut dan jadi aron tambahkan kelapa angkat diamkan</h5></li>
              <li><h5>Panaskan kukusan taruh daun pisang kukus nasi selama 20 menit atau sampai nasi matang</h5></li>
              <li><h5>Nasi lapola siap di sajikan</h5></li>
              </ul>         
          </div>
        </div>    
    </section>
