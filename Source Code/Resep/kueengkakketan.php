   ...
   <!-- Sidebar --> 
    ...
    <div class="container">
      <div class="row mb-4" style="text-align:center;">
          <h1 style="font-family: 'Lobster', cursive;">KUE ENGKAK KETAN</h1>
          <br>
          <h3 style="font-family: 'Lobster', cursive;">RESEP MAKANAN DAERAH KHAS YANG BERASAL DARI PROVINSI LAMPUNG</h3>
      </div>
      ...
      <div class="image">
          ...
          <img src="Gambar/Sumatera/kueengkakketan.jpg" alt="Kue Engkak" width="1150" height="auto" class="img-fluid">
      </div>        
    </div>
    <br>
    ...
    <section id="ingredients" class="ingredients-container document-section">
        <div class="row">
          <div class="col mt-2">
            ...
            <ul type="disc">
              <li><h5>10 butir telur</h5></li>
              <li><h5>1 kg gula pasir</h5></li>
              <li><h5>200 gr tepung ketan putih</h5></li>
              <li><h5>200 gr margarin</h5></li>
              <li><h5>2 liter santan dari 1 buah kelapa</h5></li>
              <li><h5>2 bungkus vanili bubuk</h5></li>             
            </ul>
          </div>
          <div class="col mt-2">
            <h2 class="text" style="font-family: 'Lobster', cursive; margin-bottom: 20px;">Langkahnya :</h2>
            <ul type="circle">
              <li><h5>Masak santan hingga mendidih dan mengeluarkan minyak, dinginkan, takar menjadi 1 liter / 4 gelas belimbing</h5></li>
              <li><h5>Lelehkan margarin dengan cara ditim, sisihkan</h5></li>
              <li><h5>Kocok telur menggunakan mixer hingga mengembang, masukkan gula mixer lagi hingga gula larut</h5></li>
              <li><h5>Masukkan vanili bubuk mixer hingga rata</h5></li>
              <li><h5>Masukkan rebusan santan tadi mixer lagi</h5></li>
              <li><h5>Terakhir masukkan margarin aduk rata</h5></li>
              <li><h5>Panaskan oven di 250° selama 10-15 menit</h5></li>
              <li><h5>Lalu semir loyang 20x20 dan taburi tepung, masukkan kedalam oven, oven sebentar agar loyang kering</h5></li>
              <li><h5>Tuang adonan dengan takaran yang sama setiap lapisnya, ratakan (80 gram / 4 sendok sayur)</h5></li>
              <li><h5>Gunakan rak tengah dan api atas, dengan suhu 250° selama ±15 menit</h5></li>
              <li><h5>Keluarkan, tekan rata dan lembut permukaannya dengan penekan dan sedikit margarin tekan agar rata dan padat</h5></li>
              <li><h5>Lapisan kedua, tuang adonan, ratakan dan oven. Ulangi hingga adonan habis.</h5></li>
              <li><h5>Setelah matang, keluarkan loyang dari oven, biarkan hingga dingin, balikan, setelah itu bisa simpan di wadah kedap udara atau masukkan kulkas</h5></li>  
            </ul>         
          </div>
        </div>    
    </section>
